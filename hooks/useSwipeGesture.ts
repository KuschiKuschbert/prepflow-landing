...
/**
 * Hook to detect swipe gestures (primarily swipe-up)
 * Used for opening search and drawer from bottom nav
 */
export function useSwipeGesture({
  ...
  const onTouchMove = useCallback(
    (e: React.TouchEvent) => {
      ...
      const deltaY = startY.current - currentY; // Positive = upward swipe
  ...
  const onTouchEnd = useCallback(
    (e?: React.TouchEvent) => {
      ...
      const distance = startY.current - endY; // Positive = upward swipe
