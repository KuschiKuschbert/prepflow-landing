...
export class FontOptimizer {
  ...
  private trackFontPerformance(fontName: string, loadTime: number, weight: number, style: string): void {
...
export function trackFontPerformance(fontName: string, loadTime: number, weight: number, style: string): void {
  if (typeof window !== 'undefined' && window.gtag) {
