...
<body>
  ...
  <div class="content-wrapper">
    <!-- Header -->
    <header class="header">
      <img src="${logoDataUri}" alt="PrepFlow Logo" class="logo" />
