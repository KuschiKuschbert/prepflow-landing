/**
 * Recipe population data for populate-recipes API endpoint
 * Extracted to reduce route.ts file size
 */
...
export const sampleRecipesForPopulate = [
  {
...
export const sampleRecipeIngredientsForPopulate = [
  // Classic Beef Burger
  {
