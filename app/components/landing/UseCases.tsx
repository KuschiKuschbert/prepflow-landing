...
import { ChefHat, Coffee, Truck, UtensilsCrossed } from 'lucide-react';
           ...
           >
             <div className="mb-4">
               <Icon
                 icon={useCase.icon}
                 size="xl"
                 className={useCase.colorClass}
                 aria-hidden={true}
               />
             </div>
             <h3 className={`text-fluid-xl mb-2 font-semibold ${useCase.colorClass}`}>
               {useCase.title}
             </h3>
