      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid gap-8 md:grid-cols-4">
          ...
          <div className="md:col-span-2">
            <h3 className="mb-4 text-xl font-bold text-white">PrepFlow</h3>
          ...
          <div>
            ...
            <nav className="flex flex-col space-y-2">
              <Link
                href="/privacy-policy"
                className="text-sm text-gray-400 transition-colors hover:text-[#29E7CD] focus:text-[#29E7CD] focus:outline-none"
              >
                Privacy Policy
              </Link>
              <Link
        ...
        <div className="mt-8 border-t border-gray-800 pt-8 text-center">
          <p className="text-sm text-gray-500">© {currentYear} PrepFlow. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
