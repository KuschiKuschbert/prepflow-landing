    ...
    <section id="global-features" className="py-20">
      <div className="rounded-3xl border border-[#29E7CD]/30 bg-gradient-to-br from-[#29E7CD]/10 to-[#D925C7]/10 p-10 shadow-2xl backdrop-blur-sm">
        <div className="text-center">
          ...
          <div className="mt-8 grid gap-6 desktop:grid-cols-4">
            <div className="rounded-2xl bg-[#1f1f1f]/50 p-6">
              <h3 className="mb-3 text-fluid-lg font-semibold text-[#29E7CD]">
            ...
            <div className="rounded-2xl bg-[#1f1f1f]/50 p-6">
              <h3 className="mb-3 text-fluid-lg font-semibold text-[#3B82F6]">
            ...
            <div className="rounded-2xl bg-[#1f1f1f]/50 p-6">
              <h3 className="mb-3 text-fluid-lg font-semibold text-[#D925C7]">
