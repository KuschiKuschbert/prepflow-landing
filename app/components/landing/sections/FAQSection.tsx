    ...
    <section id="faq" className={getSectionClasses({ padding: 'medium' })}>
      ...
      <div className={`${LANDING_LAYOUT.containerNarrow} space-y-6`}>
        <div className="rounded-2xl border border-white/10 bg-surface/50 p-6">
          <h4 className={`${LANDING_TYPOGRAPHY.lg} mb-3 font-semibold text-landing-primary`}>
        ...
        <div className="rounded-2xl border border-white/10 bg-surface/50 p-6">
          <h4 className={`${LANDING_TYPOGRAPHY.lg} mb-3 font-semibold text-landing-secondary`}>
         ...
         <div className="rounded-2xl border border-white/10 bg-surface/50 p-6">
           <h4 className={`${LANDING_TYPOGRAPHY.lg} mb-3 font-semibold text-landing-accent`}>
