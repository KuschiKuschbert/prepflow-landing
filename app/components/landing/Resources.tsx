      ...
      <div className="rounded-3xl border border-[#29E7CD]/30 bg-gradient-to-br from-[#29E7CD]/10 to-[#D925C7]/10 p-10 backdrop-blur-sm">
        ...
        <div className="desktop:grid-cols-3 mt-8 grid gap-6">
          <div className="rounded-2xl bg-[#1f1f1f]/50 p-6 text-center">
            <h3 className="text-fluid-lg mb-2 font-semibold text-[#29E7CD]">Secure sign‑in</h3>
        ...
        <div className="mt-8 rounded-2xl border border-[#2a2a2a] bg-[#1f1f1f]/50 p-6">
          <h3 className="text-fluid-xl mb-4 text-center font-semibold text-white">Need help?</h3>
        ...
        <ul className="text-fluid-sm mx-auto mt-8 grid max-w-3xl list-inside list-disc gap-2 text-gray-400">
