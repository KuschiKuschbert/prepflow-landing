        ...
        {recipeIngredients.length === 0 ? (
          ...
          recipeIngredients.map((ri, index) => {
            ...
            return (
              ...
              >
                <div
                  className={`grid grid-cols-12 items-center gap-4 transition-opacity duration-200 ${isChecked ? 'opacity-50' : 'opacity-100'}`}
                >
                  <div className="col-span-1 flex justify-center text-center">
                    {interactive ? (
                      <Icon
                        ...
                        size="sm"
                        className={
                          isChecked ? 'text-emerald-500' : 'text-[var(--foreground-muted)]'
                        }
                      />
                    ) : (
                      <span
                        className={`font-mono text-sm ${isMissing ? 'text-rose-400' : 'text-[var(--foreground-muted)]'}`}
                      >
                  ...
                  <div className="col-span-8">
                    <div className="flex items-center gap-2">
                      ...
                      {isMissing && !isChecked && (
                        <span className="inline-flex items-center rounded-md bg-rose-500/10 px-1.5 py-0.5 text-[10px] font-medium text-rose-300 ring-1 ring-rose-500/20 ring-inset">
                          Missing
                        </span>
                      )}
                    </div>
