...
export function parseIngredient(ing: AIIngredient | string, index: number): RecipeIngredientWithDetails {
    let quantity = 1;
    let unit = 'pc';
    let name = '';
...
export function adaptAiToUnified(aiRecipe: APIRecipe): { recipe: UnifiedRecipe, ingredients: RecipeIngredientWithDetails[] } {
