  ...
  return (
    <>
      <div className="fixed inset-0 z-[80] flex items-center justify-center bg-black/50 p-4">
        <div className="w-full max-w-2xl rounded-3xl border border-[#2a2a2a] bg-[#1f1f1f] p-6 text-white">
          {/* Header */}
          ...
          <div className="mb-6 flex items-start gap-3 rounded-xl border border-yellow-500/30 bg-yellow-500/10 p-4">
            ...
            <div className="flex-1 text-sm text-yellow-200">
              ...
              <p className="mt-1 text-yellow-300/80">
                {mode === 'full' && 'This will replace all your current data with the backup data.'}
                {mode === 'selective' &&
          ...
          {mode === 'selective' && (
            <div className="mb-6">
              <label className="mb-3 block text-sm font-medium text-gray-300">Select Tables</label>
