...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      'Go to the Setup page and scroll to the "Danger Zone" section. Click "Reset Your Data" to delete all your ingredients, recipes, menu dishes, and other data. This action cannot be undone. You can optionally reseed with clean test data after resetting.',
    category: 'webapp',
  },
  // General Questions
  {
