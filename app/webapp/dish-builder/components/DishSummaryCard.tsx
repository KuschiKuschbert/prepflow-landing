      ...
      <div className="grid grid-cols-2 gap-4 tablet:grid-cols-4">
        ...
        <div className="rounded-xl border border-[#2a2a2a]/50 bg-[#1f1f1f]/50 p-4">
          <div className="mb-2 flex items-center gap-2">
            ...
            <span className="text-xs font-medium tracking-wide text-gray-400 uppercase">Ingredients</span>
          </div>
        ...
        <div className="rounded-xl border border-[#2a2a2a]/50 bg-[#1f1f1f]/50 p-4">
          <div className="mb-2 flex items-center gap-2">
            ...
            <span className="text-xs font-medium tracking-wide text-gray-400 uppercase">Total COGS</span>
          </div>
        ...
        <div className="rounded-xl border border-[#2a2a2a]/50 bg-[#1f1f1f]/50 p-4">
          <div className="mb-2 flex items-center gap-2">
            ...
            <span className="text-xs font-medium tracking-wide text-gray-400 uppercase">Per Portion</span>
          </div>
        ...
        <div className="rounded-xl border border-[#29E7CD]/50 bg-gradient-to-br from-[#29E7CD]/20 to-[#D925C7]/20 p-4">
          <div className="mb-2 flex items-center gap-2">
            ...
            <span className="text-xs font-medium tracking-wide text-[#29E7CD] uppercase">Recommended</span>
          </div>
          {pricingCalculation ? (
            <>
