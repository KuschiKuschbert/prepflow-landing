        ...
        <div className="mb-4 rounded-xl border-2 border-dashed border-[#29E7CD]/30 bg-gradient-to-br from-[#1f1f1f] to-[#1f1f1f]/50 p-8 text-center">
          ...
          <div className="mx-auto max-w-md space-y-2 text-left text-sm text-gray-400">
            <div className="flex items-start gap-3">
              ...
              <div>
                <span className="font-medium text-gray-300">Tap a recipe</span> to add all its ingredients at once
              </div>
            </div>
            <div className="flex items-start gap-3">
              <span className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-[#29E7CD]/20 font-semibold text-[#29E7CD]">
              ...
              <div>
                <span className="font-medium text-gray-300">Tap an ingredient</span> to add it individually (you'll set the quantity)
              </div>
            </div>
            <div className="flex items-start gap-3">
              <span className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-[#29E7CD]/20 font-semibold text-[#29E7CD]">
              ...
              <div>
                <span className="font-medium text-gray-300">COGS and pricing</span> calculate automatically as you add ingredients
              </div>
            </div>
          </div>
        </div>
