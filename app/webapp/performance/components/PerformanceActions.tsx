  ...
  return (
    <div className="tablet:gap-4 desktop:mb-6 mb-4 flex flex-wrap gap-3">
      <button
        ...
        className="tablet:w-auto tablet:px-6 tablet:text-base flex min-h-[36px] w-full items-center justify-center gap-2 rounded-lg px-3 py-2 text-sm font-medium text-[var(--primary-text)] transition-colors"
        style={{
      ...
      <button
        onClick={onExportCSV}
        className="tablet:w-auto tablet:px-6 tablet:text-base flex min-h-[36px] w-full items-center justify-center gap-2 rounded-lg px-3 py-2 text-sm font-medium text-[var(--foreground)] transition-colors"
        style={{
