      ...
      <div className="relative text-right" ref={scoreRef}>
        ...
        >
          <div className={`text-2xl font-bold`}>
            {mounted ? performanceScore : 0}/100
          </div>
        ...
        {showTooltip && tips.length > 0 && (
          ...
          >
            ...
            <div className="absolute -top-2 right-4 h-0 w-0 border-4 border-b-[#1f1f1f] border-l-transparent border-r-transparent border-t-transparent" />
          </div>
        )}
      </div>
    </div>
