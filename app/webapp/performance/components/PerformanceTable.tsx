        ...
        <table className="w-full">
          <thead>
            <tr className="bg-gradient-to-r from-[#2a2a2a]/50 to-[#2a2a2a]/20">
              <th className="px-4 py-3 text-left text-sm font-medium text-gray-300">Dish</th>
              <th className="px-4 py-3 text-left text-sm font-medium text-gray-300">Number Sold</th>
              ...
              <th className="px-4 py-3 text-left text-sm font-medium text-gray-300">Total Cost</th>
              <th className="px-4 py-3 text-left text-sm font-medium text-gray-300">
                Total Profit ex GST
              </th>
              <th className="px-4 py-3 text-left text-sm font-medium text-gray-300">
              ...
              <th className="px-4 py-3 text-left text-sm font-medium text-gray-300">Profit Cat</th>
              <th className="px-4 py-3 text-left text-sm font-medium text-gray-300">
                Popularity Cat
              </th>
              <th className="px-4 py-3 text-left text-sm font-medium text-gray-300">
          ...
          <tbody>
            {performanceItems.map((item, index) => (
              <tr
                key={item.id}
                className="border-t border-[#2a2a2a] transition-colors hover:bg-[#2a2a2a]/20"
              >
                <td className="px-4 py-3 font-medium text-white">{item.name}</td>
                <td className="px-4 py-3 text-center text-gray-300">{item.number_sold}</td>
