...
function OrderListItem({
  ...
  item: OrderListFormData['items'][0];
  index: number;
  ingredients: Ingredient[];
  ...
  return (
    <div className="rounded-xl bg-[var(--muted)]/30 p-4">
      <div className="desktop:grid-cols-4 mb-3 grid grid-cols-1 gap-3">
  ...
  return (
    <div className="max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-3xl border border-[var(--border)] bg-[var(--surface)] p-6">
      ...
      <form onSubmit={onSubmit} className="space-y-6">
        <OrderListBasicInfo formData={formData} setFormData={setFormData} suppliers={suppliers} />
