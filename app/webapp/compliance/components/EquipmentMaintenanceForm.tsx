  ...
  return (
    <div className="rounded-3xl border border-[#2a2a2a] bg-[#1f1f1f] p-6 shadow-lg">
      <div className="mb-4 flex items-center justify-between">
        <h3 className="text-xl font-semibold text-white">Add Equipment Maintenance Record</h3>
      ...
      <form onSubmit={onSubmit} className="desktop:grid-cols-2 grid grid-cols-1 gap-4">
        ...
        <div>
          <label className="mb-2 block text-sm font-medium text-gray-300">Service Provider</label>
          <input
            type="text"
        ...
        <div>
          <label className="mb-2 block text-sm font-medium text-gray-300">Cost (AUD)</label>
          <input
            type="number"
            step="0.01"
            value={formData.cost}
