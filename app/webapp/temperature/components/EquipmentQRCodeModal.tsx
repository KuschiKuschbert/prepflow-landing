...
export function EquipmentQRCodeModal({
  ...
  return (
    ...
    >
      <div
        ref={modalRef}
        className="relative w-full max-w-md max-h-[95vh] rounded-2xl bg-gradient-to-br from-[#1f1f1f] to-[#2a2a2a] border border-[#2a2a2a] shadow-2xl p-3 lg:p-4 overflow-hidden flex flex-col"
