        ...
        {tabs.map(tab => {
          ...
          return (
            <button
              ...
              className={`group relative flex min-h-[44px] flex-1 items-center justify-center gap-2 rounded-2xl px-4 py-3 font-medium transition-all duration-300 focus:ring-2 focus:ring-[#29E7CD] focus:ring-offset-2 focus:ring-offset-[#0a0a0a] focus:outline-none sm:px-6 ${
                isActive
