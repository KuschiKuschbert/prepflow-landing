  ...
  return (
    <div className="mb-4 rounded-2xl border border-[#2a2a2a] bg-[#2a2a2a]/30 p-4">
      ...
      <div className="flex items-center justify-between">
        <div>
          <div className="text-lg font-bold text-white">{lastLogInfo.temperature.toFixed(1)}°C</div>
          ...
          <div className="flex items-center gap-2 rounded-full border border-[#2a2a2a] bg-[#2a2a2a]/50 px-3 py-1.5">
            <div
              className={`h-2 w-2 rounded-full shadow-lg ${
                lastLogInfo.isInRange ? 'animate-pulse bg-green-500' : 'animate-pulse bg-red-500'
              }`}
            />
            <span
