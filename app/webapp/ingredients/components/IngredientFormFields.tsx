  ...
  return (
    <>
      ...
      <div className="desktop:grid-cols-2 grid grid-cols-1 gap-4">
        <div>
          ...
          <input
            ...
            className="w-full rounded-2xl border border-[var(--border)] bg-[var(--muted)] px-3 py-2 text-[var(--foreground)] placeholder-gray-400 focus:border-transparent focus:ring-2 focus:ring-[var(--primary)]"
            placeholder="e.g., Tomatoes"
            required
          />
          {errors.ingredient_name && (
            <p className="mt-1 text-sm text-[var(--color-error)]">{errors.ingredient_name}</p>
          )}
        </div>
      ...
      <div className="grid grid-cols-1 gap-4">
        <div>
          ...
          <select
            ...
            className="w-full rounded-2xl border border-[var(--border)] bg-[var(--muted)] px-3 py-2 text-[var(--foreground)] focus:border-transparent focus:ring-2 focus:ring-[var(--primary)]"
          >
      ...
      <div className="desktop:grid-cols-3 grid grid-cols-1 gap-4">
        ...
        <div>
          <label className="mb-1 flex items-center gap-2 text-sm font-medium text-[var(--foreground-secondary)]">
            Pack Size Unit
