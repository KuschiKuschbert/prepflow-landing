...
export function IngredientTableFilterBar({
  ...
  return (
    <div className="sticky top-0 z-30 border-b border-[#2a2a2a] bg-[#1f1f1f]/95 p-4 backdrop-blur-sm">
      <div className="flex flex-wrap items-center gap-3">
        ...
        <div className="relative min-w-[200px] flex-1">
          ...
          <input
            ...
            className="w-full rounded-xl border border-[#2a2a2a] bg-[#0a0a0a]/80 px-10 py-2 text-sm text-white placeholder-gray-500 transition-all duration-200 focus:border-[#29E7CD]/50 focus:bg-[#0a0a0a] focus:ring-2 focus:ring-[#29E7CD]/20 focus:outline-none"
          />
          {localSearchTerm && (
            <button
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-2 rounded-xl border border-[#2a2a2a] bg-[#0a0a0a]/80 px-3 py-2 text-sm font-medium text-gray-300 transition-all duration-200 hover:border-[#29E7CD]/50 hover:bg-[#1f1f1f] hover:text-[#29E7CD]"
          >
        ...
        <select
          ...
          className="rounded-xl border border-[#2a2a2a] bg-[#0a0a0a]/80 px-3 py-2 text-sm font-medium text-gray-300 transition-all duration-200 hover:border-[#2a2a2a] hover:bg-[#1f1f1f] focus:border-[#29E7CD]/50 focus:ring-2 focus:ring-[#29E7CD]/20 focus:outline-none"
          title="Display unit"
        >
        ...
        {activeFilterCount > 0 && (
          <button
            ...
            className="flex items-center gap-2 rounded-xl border border-gray-600/30 bg-gray-600/10 px-3 py-2 text-sm font-medium text-gray-400 transition-all duration-200 hover:border-gray-500/50 hover:bg-gray-500/20 hover:text-white"
          >
            <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path
                strokeLinecap="round"
