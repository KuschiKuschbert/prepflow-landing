...
export function YieldPortionCalculator() {
  ...
  return (
    <div className="tablet:space-y-2 tablet:px-4 tablet:py-4 flex min-h-[600px] w-full flex-col space-y-1.5 overflow-y-auto px-3 py-3">
      ...
      {/* Mode Toggle */}
      <div className="tablet:gap-2 tablet:rounded-xl tablet:p-1 flex w-full gap-1 rounded-lg border border-[#2a2a2a] bg-[#2a2a2a]/30 p-0.5">
        <button
          onClick={() => {
            setCalculationMode('yield-to-portions');
            setNumberOfPortions('');
          }}
          className={`tablet:rounded-lg tablet:px-4 tablet:py-2 tablet:text-sm flex-1 rounded-md px-2 py-1.5 text-xs font-medium transition-colors ${
      ...
      <div className="tablet:space-y-4 w-full space-y-2">
        {calculationMode === 'yield-to-portions' ? (
          <>
            ...
            {numberOfPortions && (
              <div className="tablet:rounded-2xl tablet:p-6 rounded-xl bg-gradient-to-r from-[#29E7CD]/20 to-[#D925C7]/20 p-3 text-center">
                <div className="tablet:text-sm text-xs text-gray-400">Number of Portions</div>
          ...
          <>
            ...
            {totalYield && (
              <div className="tablet:rounded-2xl tablet:p-6 rounded-xl bg-gradient-to-r from-[#29E7CD]/20 to-[#D925C7]/20 p-3 text-center">
                <div className="tablet:text-sm text-xs text-gray-400">Total Recipe Yield</div>
                <div className="tablet:mt-2 tablet:text-4xl mt-1 text-2xl font-bold text-[#29E7CD]">
