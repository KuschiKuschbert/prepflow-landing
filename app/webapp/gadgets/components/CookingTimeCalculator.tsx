      ...
      <div className="tablet:space-y-4 w-full space-y-2">
        ...
        {temperature && (
          <div>
            ...
            <div className="tablet:rounded-xl tablet:px-4 tablet:py-3 rounded-lg border border-[#2a2a2a] bg-[#2a2a2a]/50 px-2 py-2 text-sm text-white">
              {temperature}°C
            </div>
          </div>
        )}
        ...
        <button
          ...
          className="tablet:rounded-2xl tablet:px-6 tablet:py-3 w-full rounded-xl bg-gradient-to-r from-[#29E7CD] to-[#D925C7] px-4 py-2 text-sm font-semibold text-white transition-all hover:shadow-lg hover:shadow-[#29E7CD]/20"
        >
        ...
        {calculatedTime !== null && (
          <div className="tablet:rounded-2xl tablet:p-6 rounded-xl bg-gradient-to-r from-[#29E7CD]/20 to-[#D925C7]/20 p-3 text-center">
            <div className="tablet:text-sm text-xs text-gray-400">Estimated Cooking Time</div>
