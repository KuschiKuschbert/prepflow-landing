        ...
        <nav className="bg-[#1f1f1f] border-b border-[#2a2a2a]">
          ...
          <div className="hidden md:block">
            <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
              <div className="flex items-center space-x-4">
                <Link href="/webapp" className="text-xl font-bold">
                  <span className="bg-gradient-to-r from-[#29E7CD] to-[#D925C7] bg-clip-text text-transparent">
                    PrepFlow
                  </span>
                </Link>
                <ul className="flex space-x-4">
                  <li><Link href="/webapp" className="text-gray-300 hover:text-[#29E7CD] transition-colors">Dashboard</Link></li>
                  <li><Link href="/webapp/ingredients" className="text-gray-300 hover:text-[#29E7CD] transition-colors">Ingredients</Link></li>
                  <li><Link href="/webapp/recipes" className="text-gray-300 hover:text-[#29E7CD] transition-colors">Recipe Book</Link></li>
                  <li><Link href="/webapp/cogs" className="text-gray-300 hover:text-[#29E7CD] transition-colors">COGS</Link></li>
                  <li><Link href="/webapp/setup" className="text-gray-300 hover:text-[#29E7CD] transition-colors">Setup</Link></li>
                </ul>
              </div>
              <div className="flex items-center space-x-4">
          ...
          <div className="md:hidden">
            <div className="px-4 py-3 flex justify-between items-center">
              <Link href="/webapp" className="text-lg font-bold">
                <span className="bg-gradient-to-r from-[#29E7CD] to-[#D925C7] bg-clip-text text-transparent">
                  PrepFlow
                </span>
              </Link>
              ...
              <div className="flex overflow-x-auto scrollbar-hide">
                ...
                <Link href="/webapp/recipes" className="flex-shrink-0 px-4 py-3 text-sm hover:text-[#29E7CD] transition-colors border-b-2 border-transparent hover:border-[#29E7CD]">
                  <div className="flex flex-col items-center space-y-1">
                    ...
                    <span className="text-xs">Recipe Book</span>
                  </div>
                </Link>
