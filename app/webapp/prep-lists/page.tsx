                  ...
                  <div className="flex flex-col space-y-2">
                    ...
                    <div className="flex space-x-2">
                      ...
                      <button
                        ...
                        title={t('prepLists.delete', 'Delete')}
                      >
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 bg-[#2a2a2a] border border-[#2a2a2a] rounded-xl text-white focus:ring-2 focus:ring-[#29E7CD] focus:border-transparent"
                    rows={3}
                    placeholder={t('prepLists.notesPlaceholder', 'Optional notes about this prep list')}
                  />
                </div>
                      ...
                      <div key={index} className="bg-[#2a2a2a]/30 rounded-xl p-4">
                        ...
                        <div className="flex items-center justify-between">
                          <input
                            ...
                            placeholder={t('prepLists.itemNotes', 'Item notes (optional)')}
                          />
                          <button
                            type="button"
