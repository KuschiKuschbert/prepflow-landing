    ...
    <>
      ...
      {isExpanded && (
        ...
        >
          <div
            ref={modalRef}
            className="animate-in zoom-in-95 flex max-h-[90vh] w-full max-w-4xl flex-col overflow-hidden rounded-3xl border border-[#2a2a2a] bg-[#1f1f1f] shadow-2xl duration-200 focus:outline-none"
