          ...
          setCalculations(prev =>
            prev.map(calc => {
              if (calc.ingredientId === newIngredient.ingredient_id) {
                ...
                const newWasteAdjustedCost =
                  newTotalCost * (1 + (calc.wasteAdjustedCost / calc.totalCost - 1));
                const newYieldAdjustedCost =
                  newWasteAdjustedCost / (calc.yieldAdjustedCost / calc.wasteAdjustedCost);

                return {
                  ...calc,
                  ingredientName: calc.ingredientName.includes('(converted from')
                    ? calc.ingredientName
                    : calc.ingredientName + conversionNote,
            ...
            <div className="mb-6">
                ...
                <div className="mt-2 flex items-center space-x-2">
                  {checkingRecipe ? (
                    ...
                    <div className="flex items-center space-x-2 text-green-400">
                      ...
                      <span className="text-sm font-medium">
                        ✅ New recipe - will create new recipe
                      </span>
                    </div>
                  ) : null}
                </div>
              ...
              {dishNameLocked && (
                <div className="mt-2 flex items-center space-x-2 text-blue-400">
                  ...
                  <span className="text-sm font-medium">
                    🔒 Dish name locked - editing ingredients
                  </span>
                </div>
              )}
            </div>
            ...
            {calculations.length > 0 ? (
                            ...
                            <div className="flex items-center space-x-2">
                              {editingIngredient === calc.ingredientId ? (
                                ...
                                <>
                                  <button
                                    onClick={() =>
                                      handleEditIngredient(calc.ingredientId, calc.quantity)
                                    }
                                    className="p-1 text-gray-400 transition-colors duration-200 hover:text-[#29E7CD]"
                                    title="Edit quantity"
                                  >
                        ...
                        <div className="rounded-2xl border border-[#29E7CD]/30 bg-gradient-to-br from-[#29E7CD]/10 to-[#D925C7]/10 p-4">
                          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                            ...
                            <div className="rounded-xl border border-[#2a2a2a]/50 bg-[#2a2a2a]/30 p-3">
                              ...
                              <div className="text-xs text-gray-400">
                                {(
                                  ((sellPriceExclGST - costPerPortion) / sellPriceExclGST) *
                                  100
                                ).toFixed(1)}
                                % margin
                              </div>
              ...
              <div className="py-8 text-center text-gray-500">
                {selectedRecipe
                  ...
                  : 'Select a recipe to calculate COGS.'}
              </div>
            )}
          </div>
        </div>
