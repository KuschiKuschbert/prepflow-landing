...
export function RecentActivityItem({ activity }: RecentActivityItemProps) {
  return (
    <div className="tablet:space-x-4 tablet:rounded-2xl tablet:p-3 glass-panel flex items-center space-x-3 rounded-xl border border-[var(--border)]/30 p-4 transition-all duration-300 hover:border-[var(--primary)]/30 hover:bg-[var(--surface-variant)]/40">
