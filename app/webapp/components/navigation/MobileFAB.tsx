  ...
  return (
    <div className="desktop:hidden fixed right-4 bottom-20 z-[70] landscape:bottom-16">
      ...
      {isOpen && (
        <div
          ref={menuRef}
          className="glass-panel mb-3 flex flex-col gap-2 rounded-2xl border border-[var(--border)] p-2 shadow-2xl landscape:gap-1 landscape:p-1.5"
        ...
        >
          ...
          >
            ...
            <div className="flex flex-col">
              ...
              <span className="landscape:text-fluid-xs text-xs text-[var(--foreground-subtle)]">
                Create a dish
              </span>
            </div>
          </button>
