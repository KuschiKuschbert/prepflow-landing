...
export function PersistentSidebar() {
  ...
  return (
    <aside
      className="fixed top-[var(--header-height-desktop)] bottom-0 left-0 z-40 w-72 tablet:w-80 desktop:w-96 border-r border-[#2a2a2a] bg-[#1f1f1f] transition-all duration-300"
      role="navigation"
