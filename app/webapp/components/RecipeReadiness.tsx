  ...
  return (
    <div className="tablet:mb-8 tablet:rounded-3xl tablet:p-6 glass-surface mb-6 rounded-2xl border border-[var(--border)]/30 p-4 shadow-lg">
      ...
      {data.mostUsedRecipes.length > 0 && (
        <div className="tablet:mt-6 tablet:rounded-2xl tablet:p-4 glass-panel mt-4 rounded-xl border border-[var(--border)]/30 p-3 shadow-sm transition-all duration-300 hover:border-[var(--primary)]/30">
