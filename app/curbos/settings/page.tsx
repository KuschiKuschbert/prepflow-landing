      ...
      <div className="bg-neutral-900 rounded-2xl p-6 tablet:p-8 border border-neutral-800 mt-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-4">
              <a
                href="https://github.com/KuschiKuschbert/CurbOS/releases/latest/download/curbos-v0.2.3-experimental-dev.apk"
              ...
              <div className="flex flex-col gap-1">
                <p className="text-[#C0FF02] font-black text-xs uppercase tracking-widest">v0.2.3-experimental-dev</p>
