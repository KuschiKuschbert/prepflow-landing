...
import { DishIngredientInput } from '../../helpers/schemas';

/**
 * Update dish ingredients by deleting existing and inserting new ones.
 *
 * @param {string} dishId - Dish ID
 * @param {DishIngredientInput[]} ingredients - Array of ingredient objects
 * @throws {Error} If database connection is not available or update fails
 */
export async function updateDishIngredients(dishId: string, ingredients: DishIngredientInput[]) {
  if (!supabaseAdmin) {
