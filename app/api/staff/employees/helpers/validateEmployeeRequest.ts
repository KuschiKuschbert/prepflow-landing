...
export function validateEmployeeRequest(body: unknown): ValidationResult {
  ...
  if (
    b.employment_type &&
    !validEmploymentTypes.includes(b.employment_type as (typeof validEmploymentTypes)[number])
  ) {
    return {
      isValid: false,
  ...
  return {
    ...
    data: {
      ...
      saturday_rate:
        b.saturday_rate !== undefined ? parseFloat(String(b.saturday_rate)) : undefined,
      ...
      bank_account_number:
        typeof b.bank_account_number === 'string' ? b.bank_account_number : undefined,
