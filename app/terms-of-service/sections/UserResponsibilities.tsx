  ...
  return (
    <>
      ...
      <ul className="ml-4 list-inside list-disc space-y-2 text-gray-300">
        <li className="text-fluid-base">Violate any laws or regulations</li>
        <li className="text-fluid-base">Infringe on intellectual property rights</li>
        <li className="text-fluid-base">Transmit malicious code or viruses</li>
        <li className="text-fluid-base">Harass, abuse, or harm others</li>
        <li className="text-fluid-base">Collect or harvest user data without authorization</li>
