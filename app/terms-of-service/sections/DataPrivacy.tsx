  ...
  return (
    <>
      <p className="mb-4 leading-relaxed text-gray-300">
        <strong>Data Collection:</strong> PrepFlow collects and processes data necessary to provide
      ...
      <ul className="ml-4 list-inside list-disc space-y-2 text-gray-300">
        ...
        <li className="text-fluid-base">
          Business data (ingredients, recipes, menu items, costs, sales data)
        </li>
        <li className="text-fluid-base">
      ...
      <p className="mb-4 leading-relaxed text-gray-300">
        <strong>Data Storage:</strong> Your data&apos;s stored securely using industry-standard
        encryption (both while it&apos;s traveling and when it&apos;s at rest). We use trusted
        providers and implement strong security measures to protect your information.
      </p>
      <p className="mb-4 leading-relaxed text-gray-300">
      ...
      <p className="mb-4 leading-relaxed text-gray-300">
        <strong>Data Sharing:</strong> We don&apos;t sell your data to third parties. We may share
        data with:
      </p>
      <ul className="ml-4 list-inside list-disc space-y-2 text-gray-300">
        <li className="text-fluid-base">
        ...
        <li className="text-fluid-base">
          <strong>Supabase:</strong> Secure data hosting and storage
        </li>
        <li className="text-fluid-base">
      ...
      <p className="mb-4 leading-relaxed text-gray-300">
        <strong>GDPR Compliance:</strong> For users in the European Union, PrepFlow complies with
      ...
      <p className="text-fluid-base leading-relaxed text-gray-300">
        <strong>Privacy Policy:</strong> For detailed information about our data practices, please
        review our{' '}
