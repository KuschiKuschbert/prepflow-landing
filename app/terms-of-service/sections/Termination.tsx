  ...
  return (
    <>
      ...
      <p className="mb-4 leading-relaxed text-gray-300">
        ...
        immediately if you violate these Terms, engage in fraudulent or illegal activities, fail to
        pay subscription fees, or if we discontinue the Service. We will provide reasonable notice
        when possible, except in cases of serious violations or illegal activity.
      </p>
      <p className="mb-4 leading-relaxed text-gray-300">
      ...
      <p className="mt-4 leading-relaxed text-gray-300">
        <strong>Data Retention:</strong> After termination, we may retain your data for a period of
        up to 90 days for backup and recovery purposes. After this period, we will delete your data
        unless we are required to retain it for legal or regulatory purposes. You are responsible
