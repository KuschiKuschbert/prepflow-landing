  ...
  return (
    <>
      <p className="mb-4 leading-relaxed text-gray-300">
        PrepFlow is a web-based Software-as-a-Service (SaaS) platform that provides comprehensive
        restaurant profitability optimization tools, including:
      </p>
      ...
      <p className="mt-4 leading-relaxed text-gray-300">
        The Service is designed to assist restaurant owners, managers, and chefs in making informed
        business decisions. However, we don&apos;t guarantee specific financial outcomes. Feature
        availability may vary based on your subscription tier.
      </p>
    </>
  );
}
