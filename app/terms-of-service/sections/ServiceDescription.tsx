  ...
  return (
    <>
      <p className="mb-4 leading-relaxed text-gray-300">
        PrepFlow is a web-based Software-as-a-Service (SaaS) platform that provides comprehensive restaurant
        profitability optimization tools, including:
      </p>
      <ul className="ml-4 list-inside list-disc space-y-2 text-gray-300">
        ...
        <li className="text-fluid-base">COGS (Cost of Goods Sold) calculator with advanced pricing strategies</li>
        <li className="text-fluid-base">Menu profitability analysis and performance insights</li>
      ...
      <p className="mt-4 leading-relaxed text-gray-300">
        The Service is designed to assist restaurant owners, managers, and chefs in making informed business decisions.
        However, we do not guarantee specific financial outcomes. Feature availability may vary based on your
        subscription tier.
      </p>
    </>
  );
