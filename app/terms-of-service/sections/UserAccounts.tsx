  ...
  return (
    <>
      <p className="mb-4 leading-relaxed text-gray-300">
        To access PrepFlow, you must create an account using our authentication provider (Auth0).
        You agree to:
      </p>
      ...
      <p className="mt-4 leading-relaxed text-gray-300">
        ...
        of your account credentials. We use Auth0 for authentication, which provides
        industry-standard security measures. However, you must not share your credentials with
        others or allow unauthorized access to your account.
      </p>
      <p className="mt-4 leading-relaxed text-gray-300">
        <strong>Account Termination:</strong> We reserve the right to suspend or terminate accounts
        that violate these Terms or engage in fraudulent, abusive, or illegal activities.
      </p>
    </>
  );
}
