...
export default function Background() {
    return (
        <div className="fixed inset-0 z-[-1] overflow-hidden bg-neutral-950">
            ...
            {/* Geometric Triangles */}
            <Triangle className="text-lime-500 w-96 h-96 -top-20 -left-20 rotate-12" />
            <Triangle className="text-lime-700 w-64 h-64 top-40 right-10 -rotate-12 opacity-5" />
            <Triangle className="text-neutral-700 w-[500px] h-[500px] -bottom-32 -right-32 rotate-45 opacity-5" />
            ...
            <div className="absolute bottom-10 right-10 md:hidden scale-50">
                <RotatingLogo />
            </div>
