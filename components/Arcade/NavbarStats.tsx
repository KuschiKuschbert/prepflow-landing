...
export const NavbarStats: React.FC = () => {
  ...
  return (
    <div className="flex items-center gap-1 text-white/80 md:gap-1.5 lg:gap-2">
      <div
        title="Tomatoes Thrown"
        className="flex items-center gap-0.5 md:gap-1"
        style={{ fontSize: '14px' }}
      >
        <span className="text-fluid-sm leading-none md:text-fluid-base lg:text-fluid-lg">🍅</span>
        <span className="text-[10px] leading-none md:text-[11px] lg:text-fluid-xs">{stats.tomatoes}</span>
      </div>
      <div
      ...
      >
        <span className="text-fluid-sm leading-none md:text-fluid-base lg:text-fluid-lg">🧾</span>
        <span className="text-[10px] leading-none md:text-[11px] lg:text-fluid-xs">{stats.dockets}</span>
      </div>
      <div
      ...
      >
        <span className="text-fluid-sm leading-none md:text-fluid-base lg:text-fluid-lg">🔥</span>
        <span className="text-[10px] leading-none md:text-[11px] lg:text-fluid-xs">{stats.fires}</span>
      </div>
    </div>
  );
};
