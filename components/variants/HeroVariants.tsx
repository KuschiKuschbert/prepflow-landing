      ...
      <div>
        ...
        <div className="mt-10 flex flex-wrap items-center gap-4">
          <a
            ...
            className="rounded-2xl bg-gradient-to-r from-[#29E7CD] to-[#3B82F6] px-8 py-4 text-base font-semibold text-white shadow-lg transition-all duration-300 hover:shadow-xl hover:shadow-[#29E7CD]/25"
          ...
          <div className="relative">
            <OptimizedImage
              ...
              alt={String(
                t(
                  'hero.dashboardAlt',
                  'PrepFlow Dashboard showing COGS metrics, profit analysis, and item performance charts',
                ),
              )}
              width={800}
              height={500}
            ...
            <div className="absolute inset-0 flex items-center justify-center rounded-xl bg-black/40">
              <div className="text-center text-white">
                <div className="mb-2 rounded-lg bg-[#29E7CD] px-4 py-2 font-semibold text-black">
                  Live GP% Dashboard
                </div>
    ...
    <section id="hero" className="grid items-center gap-12 py-16 md:grid-cols-2 md:py-24">
      <div>
        ...
        <div className="mt-10 flex flex-wrap items-center gap-4">
          <a
            href="#lead-magnet"
            className="rounded-2xl bg-gradient-to-r from-[#D925C7] to-[#29E7CD] px-8 py-4 text-base font-semibold text-white shadow-lg transition-all duration-300 hover:shadow-xl hover:shadow-[#D925C7]/25"
            onClick={() => handleEngagement?.('hero_cta_click')}
          >
          ...
          <a
            href="#lead-magnet"
            className="rounded-2xl border border-gray-600 px-8 py-4 text-base font-semibold text-gray-300 transition-all duration-300 hover:border-[#D925C7] hover:text-[#D925C7]"
            onClick={() => handleEngagement?.('hero_demo_click')}
          >
      ...
      <div className="relative">
        ...
        <div className="rounded-3xl border border-gray-700 bg-[#1f1f1f]/80 p-6 shadow-2xl backdrop-blur-sm">
          <div className="relative">
            ...
            <div className="absolute inset-0 flex items-center justify-center rounded-xl bg-black/40">
              <div className="text-center text-white">
                <div className="mb-2 rounded-lg bg-[#D925C7] px-4 py-2 font-semibold text-white">
          ...
          <p className="mt-4 text-center text-sm text-gray-500">
            Profit Analysis · Recipe Costing · Stock Management
          </p>
        </div>
      </div>
    </section>
    ...
    <section id="hero" className="grid items-center gap-12 py-16 md:grid-cols-2 md:py-24">
      <div>
        ...
        <div className="mt-10 flex flex-wrap items-center gap-4">
          <a
            href="#lead-magnet"
            className="rounded-2xl bg-gradient-to-r from-[#3B82F6] to-[#29E7CD] px-8 py-4 text-base font-semibold text-white shadow-lg transition-all duration-300 hover:shadow-xl hover:shadow-[#3B82F6]/25"
            onClick={() => handleEngagement?.('hero_cta_click')}
          >
          ...
          <a
            href="#lead-magnet"
            className="rounded-2xl border border-gray-600 px-8 py-4 text-base font-semibold text-gray-300 transition-all duration-300 hover:border-[#3B82F6] hover:text-[#3B82F6]"
            onClick={() => handleEngagement?.('hero_demo_click')}
          >
      ...
      <div className="relative">
        ...
        <div className="rounded-3xl border border-gray-700 bg-[#1f1f1f]/80 p-6 shadow-2xl backdrop-blur-sm">
          <div className="relative">
            ...
            <div className="absolute inset-0 flex items-center justify-center rounded-xl bg-black/40">
              <div className="text-center text-white">
                <div className="mb-2 rounded-lg bg-[#3B82F6] px-4 py-2 font-semibold text-white">
                  Profit Optimization
                </div>
                <button className="rounded-lg bg-white px-6 py-3 font-semibold text-black transition-colors hover:bg-gray-100">
                  View Dashboard
          ...
          <p className="mt-4 text-center text-sm text-gray-500">
            Profit Dashboard · Recipe Analysis · Stock Tracking
          </p>
        </div>
      </div>
    </section>
    ...
    <section id="hero" className="grid items-center gap-12 py-16 md:grid-cols-2 md:py-24">
      ...
      <div className="relative">
        ...
        <div className="rounded-3xl border border-gray-700 bg-[#1f1f1f]/80 p-6 shadow-2xl backdrop-blur-sm">
          ...
          <p className="mt-4 text-center text-sm text-gray-500">
            Cost Analysis · Recipe Costs · Stock List
          </p>
        </div>
      </div>
    </section>
