...
export function ResponsivePageContainer({
  ...
  return (
    <div
      className={`w-full mx-auto px-4 tablet:px-6 desktop:px-8 large-desktop:px-12 xl:px-16 2xl:px-20 tablet:max-w-2xl desktop:max-w-7xl large-desktop:max-w-[1440px] xl:max-w-[1920px] 2xl:max-w-[2560px] ${className}`}
    >
      {children}
    </div>
  );
