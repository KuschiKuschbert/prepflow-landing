...
const KitchenOnFire: React.FC = () => {
  ...
  return (
    <main className="fixed inset-0 flex min-h-screen items-center justify-center bg-[#0a0a0a] p-6 text-white">
        ...
        <AnimatePresence mode="wait">
          {!extinguished ? (
            <>
              ...
              {/* Animated flames */}
              <motion.div
                className="mb-8 flex flex-wrap justify-center gap-4 text-6xl md:text-7xl"
