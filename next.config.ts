    ...
    const headers = [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value:
              "default-src 'self'; img-src 'self' data: blob: https:; style-src 'self' 'unsafe-inline'; font-src 'self' data:; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.googletagmanager.com https://www.google-analytics.com https://vercel.live; connect-src 'self' https: wss: https://*.supabase.co wss://*.supabase.co https://vercel.live; frame-ancestors 'none'",
          },
        ],
      },
      {
