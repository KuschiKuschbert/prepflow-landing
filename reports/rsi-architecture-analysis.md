...
### Spaghetti Code (HIGH)
**File:** `app/admin/components/AdminNavigation.tsx`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Spaghetti Code (HIGH)
**File:** `app/admin/features/hooks/useFlagAutoCreate.ts`
**Description:** Code has 7 levels of nesting
**Suggestion:** Extract nested logic into separate functions

### Spaghetti Code (HIGH)
**File:** `app/admin/features/hooks/useFlagDiscovery.ts`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Spaghetti Code (HIGH)
**File:** `app/admin/tiers/components/TierCard.tsx`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Spaghetti Code (HIGH)
**File:** `app/api/admin/billing/health/route.ts`
**Description:** Code has 7 levels of nesting
**Suggestion:** Extract nested logic into separate functions

### Spaghetti Code (HIGH)
**File:** `app/api/admin/billing/overview/route.ts`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Spaghetti Code (HIGH)
**File:** `app/api/admin/data/export/route.ts`
**Description:** Code has 7 levels of nesting
**Suggestion:** Extract nested logic into separate functions

### Spaghetti Code (HIGH)
**File:** `app/api/admin/data/search/route.ts`
**Description:** Code has 7 levels of nesting
**Suggestion:** Extract nested logic into separate functions

### Spaghetti Code (HIGH)
**File:** `app/api/admin/errors/[id]/helpers/updateError.ts`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions

### Spaghetti Code (HIGH)
**File:** `app/api/admin/errors/client/helpers/handleAutoReport.ts`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions

### Spaghetti Code (HIGH)
**File:** `app/api/admin/features/[flag]/route.ts`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Spaghetti Code (HIGH)
**File:** `app/api/admin/features/auto-create/route.ts`
**Description:** Code has 8 levels of nesting
**Suggestion:** Extract nested logic into separate functions

### Magic Numbers (MEDIUM)
**File:** `app/api/admin/security/breach-report/route.ts`
**Description:** Found 12 magic numbers
**Suggestion:** Extract magic numbers to named constants

### Magic Numbers (MEDIUM)
**File:** `app/api/admin/support/impersonate/route.ts`
...
### Spaghetti Code (HIGH)
**File:** `app/api/admin/support-tickets/[id]/helpers/updateTicket.ts`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Spaghetti Code (HIGH)
**File:** `app/api/ai/performance-insights/route.ts`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions

### Spaghetti Code (HIGH)
**File:** `app/api/ai/performance-tips/route.ts`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions

### Spaghetti Code (HIGH)
**File:** `app/api/ai/prep-details/route.ts`
**Description:** Code has 8 levels of nesting
**Suggestion:** Extract nested logic into separate functions

### Spaghetti Code (HIGH)
**File:** `app/api/ai-specials/helpers/generateAISpecials.ts`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions

### Spaghetti Code (HIGH)
**File:** `app/api/allergens/[code]/dishes/route.ts`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions

### Spaghetti Code (HIGH)
**File:** `app/api/allergens/re-aggregate-all/route.ts`
**Description:** Code has 8 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Magic Numbers (MEDIUM)
**File:** `app/api/cleaning-tasks/populate-standard/route.ts`
**Description:** Found 11 magic numbers
**Suggestion:** Extract magic numbers to named constants

### Spaghetti Code (HIGH)
**File:** `app/api/cleanup-test-data/route.ts`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions

### Spaghetti Code (HIGH)
**File:** `app/api/compliance/allergens/export/helpers/aggregateDishAllergens.ts`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions

### Spaghetti Code (HIGH)
**File:** `app/api/compliance/allergens/export/helpers/aggregateRecipeAllergens.ts`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions

### Spaghetti Code (HIGH)
**File:** `app/api/compliance/allergens/export/helpers/fetchMenuItems.ts`
**Description:** Code has 8 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Spaghetti Code (HIGH)
**File:** `app/api/compliance/health-inspector-report/helpers/generateComplianceGaps.ts`
**Description:** Code has 7 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Spaghetti Code (HIGH)
**File:** `app/api/curbos/public-token/curbos/helpers/auth-helpers.ts`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Spaghetti Code (HIGH)
**File:** `app/api/db/integrity/route.ts`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Spaghetti Code (HIGH)
**File:** `app/api/dedupe/execute/helpers/processIngredients.ts`
**Description:** Code has 7 levels of nesting
**Suggestion:** Extract nested logic into separate functions

### Spaghetti Code (HIGH)
**File:** `app/api/dedupe/execute/helpers/processRecipes.ts`
**Description:** Code has 7 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Spaghetti Code (HIGH)
**File:** `app/api/dishes/[id]/cost/route.ts`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Spaghetti Code (HIGH)
**File:** `app/api/dishes/[id]/generate-image/helpers/aggregateIngredients.ts`
**Description:** Code has 7 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Spaghetti Code (HIGH)
**File:** `app/api/dishes/[id]/helpers/fetchDishIngredients.ts`
**Description:** Code has 8 levels of nesting
**Suggestion:** Extract nested logic into separate functions

### Spaghetti Code (HIGH)
**File:** `app/api/dishes/[id]/helpers/handlePutRequest.ts`
**Description:** Code has 7 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Magic Numbers (MEDIUM)
**File:** `app/api/ingredients/bulk-update/route.ts`
**Description:** Found 13 magic numbers
**Suggestion:** Extract magic numbers to named constants
...
### Spaghetti Code (HIGH)
**File:** `app/api/ingredients/helpers/updateIngredient.ts`
**Description:** Code has 7 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Spaghetti Code (HIGH)
**File:** `app/api/kitchen-sections/route.ts`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Spaghetti Code (HIGH)
**File:** `app/api/menus/[id]/export-combined/helpers/generateRecipeCardsHTML.ts`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Spaghetti Code (HIGH)
**File:** `app/api/menus/[id]/ingredients/helpers/collectIngredientIds.ts`
**Description:** Code has 8 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Magic Numbers (MEDIUM)
**File:** `app/api/menus/[id]/items/route.ts`
**Description:** Found 12 magic numbers
**Suggestion:** Extract magic numbers to named constants
...
### Spaghetti Code (HIGH)
**File:** `app/api/menus/[id]/lock/helpers/batchFetchDishes.ts`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Magic Numbers (MEDIUM)
**File:** `app/api/menus/[id]/reorder/route.ts`
**Description:** Found 11 magic numbers
**Suggestion:** Extract magic numbers to named constants
...
### Spaghetti Code (HIGH)
**File:** `app/api/order-lists/[id]/helpers/updateOrderList.ts`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Magic Numbers (MEDIUM)
**File:** `app/api/order-lists/route.ts`
**Description:** Found 15 magic numbers
**Suggestion:** Extract magic numbers to named constants

### Spaghetti Code (HIGH)
**File:** `app/api/par-levels/helpers/fetchParLevelWithIngredient.ts`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions

### Spaghetti Code (HIGH)
**File:** `app/api/par-levels/helpers/fetchParLevels.ts`
**Description:** Code has 7 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Spaghetti Code (HIGH)
**File:** `app/api/populate-recipes/route.ts`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions

### Spaghetti Code (HIGH)
**File:** `app/api/prep-lists/analyze-prep-details/route.ts`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Spaghetti Code (HIGH)
**File:** `app/api/prep-lists/generate-from-menu/helpers/aggregateFromRecipes.ts`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions

### Spaghetti Code (HIGH)
**File:** `app/api/prep-lists/generate-from-menu/helpers/aggregateIngredients.ts`
**Description:** Code has 8 levels of nesting
**Suggestion:** Extract nested logic into separate functions

### Spaghetti Code (HIGH)
**File:** `app/api/prep-lists/generate-from-menu/helpers/analyzePrepDetails.ts`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions

### Spaghetti Code (HIGH)
**File:** `app/api/prep-lists/generate-from-menu/helpers/processDish.ts`
**Description:** Code has 7 levels of nesting
**Suggestion:** Extract nested logic into separate functions

### Spaghetti Code (HIGH)
**File:** `app/api/prep-lists/generate-from-menu/helpers/processRecipe.ts`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions

### Spaghetti Code (HIGH)
**File:** `app/api/prep-lists/generate-from-menu/route.ts`
**Description:** Code has 8 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Spaghetti Code (HIGH)
**File:** `app/api/recipe-scraper/convert-units/helpers/ingredient-conversion.ts`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions

### Spaghetti Code (HIGH)
**File:** `app/api/recipe-scraper/convert-units/helpers/unit-conversion.ts`
**Description:** Code has 7 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Spaghetti Code (HIGH)
**File:** `app/api/recipe-scraper/scrape/helpers/scraping-operations.ts`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Spaghetti Code (HIGH)
**File:** `app/api/recipes/[id]/helpers/handleRecipeUpdate.ts`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Spaghetti Code (HIGH)
**File:** `app/api/recipes/ingredients/batch/route.ts`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Spaghetti Code (HIGH)
**File:** `app/api/setup-menu-builder/route.ts`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Magic Numbers (MEDIUM)
**File:** `app/api/staff/employees/helpers/createEmployeeHandler.ts`
**Description:** Found 12 magic numbers
**Suggestion:** Extract magic numbers to named constants
...
### Magic Numbers (MEDIUM)
**File:** `app/api/temperature-logs/route.ts`
**Description:** Found 13 magic numbers
**Suggestion:** Extract magic numbers to named constants
...
**Description:** Found 29 magic numbers
**Suggestion:** Extract magic numbers to named constants
...
**Description:** Code has 10 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Spaghetti Code (HIGH)
**File:** `app/curbos/kitchen/page.tsx`
**Description:** Code has 8 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Spaghetti Code (HIGH)
**File:** `app/curbos/order/[id]/page.tsx`
**Description:** Code has 7 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Spaghetti Code (HIGH)
**File:** `app/curbos/quests/[id]/content.tsx`
**Description:** Code has 7 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Spaghetti Code (HIGH)
**File:** `app/webapp/ai-specials/components/AISpecialCard.tsx`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions

### Spaghetti Code (HIGH)
**File:** `app/webapp/ai-specials/components/RecipeScraper/ComprehensiveScraperSection.tsx`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions

### Magic Numbers (MEDIUM)
**File:** `app/webapp/ai-specials/components/RecipeScraper/ProcessingStatus/components/DiagnosticsPanel.tsx`
**Description:** Found 11 magic numbers
**Suggestion:** Extract magic numbers to named constants

### Magic Numbers (MEDIUM)
**File:** `app/webapp/ai-specials/components/RecipeScraper/RecipeListSection/utils.ts`
**Description:** Found 40 magic numbers
**Suggestion:** Extract magic numbers to named constants

### Magic Numbers (MEDIUM)
**File:** `app/webapp/ai-specials/components/RecipeScraper/components/DiagnosticsPanel.tsx`
**Description:** Found 11 magic numbers
**Suggestion:** Extract magic numbers to named constants

### Spaghetti Code (HIGH)
**File:** `app/webapp/ai-specials/components/RecipeScraper/hooks/useComprehensiveScrapingHandlers/stop-handler.ts`
**Description:** Code has 8 levels of nesting
**Suggestion:** Extract nested logic into separate functions

### Spaghetti Code (HIGH)
**File:** `app/webapp/ai-specials/components/RecipeScraper/hooks/useStatusPolling.ts`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions

### Spaghetti Code (HIGH)
**File:** `app/webapp/ai-specials/page.tsx`
**Description:** Code has 7 levels of nesting
**Suggestion:** Extract nested logic into separate functions

### Spaghetti Code (HIGH)
**File:** `app/webapp/cleaning/components/CleaningGrid.tsx`
**Description:** Code has 8 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Spaghetti Code (HIGH)
**File:** `app/webapp/cleaning/page.tsx`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Spaghetti Code (HIGH)
**File:** `app/webapp/cogs/components/COGSTableGrouped/components/COGSTableDesktop.tsx`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Spaghetti Code (HIGH)
**File:** `app/webapp/cogs/components/IngredientManager.tsx`
**Description:** Code has 7 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Magic Numbers (MEDIUM)
**File:** `app/webapp/cogs/components/SuccessMessage.tsx`
**Description:** Found 12 magic numbers
**Suggestion:** Extract magic numbers to named constants
...
### Spaghetti Code (HIGH)
**File:** `app/webapp/compliance/components/ComplianceRecordsList.tsx`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Spaghetti Code (HIGH)
**File:** `app/webapp/components/KitchenCharts.tsx`
**Description:** Code has 7 levels of nesting
**Suggestion:** Extract nested logic into separate functions

### Spaghetti Code (HIGH)
**File:** `app/webapp/components/KitchenOperations.tsx`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions

### Spaghetti Code (HIGH)
**File:** `app/webapp/components/ModernNavigation.tsx`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Spaghetti Code (HIGH)
**File:** `app/webapp/components/navigation/Sidebar.tsx`
**Description:** Code has 7 levels of nesting
**Suggestion:** Extract nested logic into separate functions

### Magic Numbers (MEDIUM)
**File:** `app/webapp/dish-builder/components/DishIngredientTable.tsx`
**Description:** Found 12 magic numbers
**Suggestion:** Extract magic numbers to named constants
...
### Spaghetti Code (HIGH)
**File:** `app/webapp/guide/components/formats/InteractiveDemo.tsx`
**Description:** Code has 7 levels of nesting
**Suggestion:** Extract nested logic into separate functions

### Spaghetti Code (HIGH)
**File:** `app/webapp/guide/components/formats/ScreenshotGuide.tsx`
**Description:** Code has 7 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Spaghetti Code (HIGH)
**File:** `app/webapp/ingredients/components/BulkAllergenDetection.tsx`
**Description:** Code has 7 levels of nesting
**Suggestion:** Extract nested logic into separate functions

### Spaghetti Code (HIGH)
**File:** `app/webapp/ingredients/components/CSVImportModal.tsx`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Magic Numbers (MEDIUM)
**File:** `app/webapp/ingredients/components/IngredientActions.tsx`
**Description:** Found 13 magic numbers
**Suggestion:** Extract magic numbers to named constants
...
### Magic Numbers (MEDIUM)
**File:** `app/webapp/ingredients/components/ModernIngredientFilters.tsx`
**Description:** Found 12 magic numbers
**Suggestion:** Extract magic numbers to named constants
...
### Spaghetti Code (HIGH)
**File:** `app/webapp/ingredients/components/useIngredientFormLogic/helpers/useCategoryDetection.ts`
**Description:** Code has 9 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Spaghetti Code (HIGH)
**File:** `app/webapp/menu-builder/components/MenuBuilderClient.tsx`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Magic Numbers (MEDIUM)
**File:** `app/webapp/performance/components/PerformanceFilters/ImportButton.tsx`
**Description:** Found 11 magic numbers
**Suggestion:** Extract magic numbers to named constants
...
### Spaghetti Code (HIGH)
**File:** `app/webapp/prep-lists/components/PrepListExport.tsx`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Spaghetti Code (HIGH)
**File:** `app/webapp/recipes/components/hooks/usePriceCalculation.ts`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Spaghetti Code (HIGH)
**File:** `app/webapp/recipes/hooks/useBulkShare.ts`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Spaghetti Code (HIGH)
**File:** `app/webapp/recipes/hooks/utils/calculateAllPrices.ts`
**Description:** Code has 7 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Spaghetti Code (HIGH)
**File:** `lib/ai/recipe-database.ts`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Spaghetti Code (HIGH)
**File:** `lib/analytics/trackers/userInteractionTracker.ts`
**Description:** Code has 8 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Spaghetti Code (HIGH)
**File:** `lib/backup/export/helpers/convertToSQL.ts`
**Description:** Code has 7 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Spaghetti Code (HIGH)
**File:** `lib/billing-sync/helpers/syncAllSubscriptions.ts`
**Description:** Code has 8 levels of nesting
**Suggestion:** Extract nested logic into separate functions

### Spaghetti Code (HIGH)
**File:** `lib/billing-sync/helpers/syncCustomerEmails.ts`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Spaghetti Code (HIGH)
**File:** `lib/feature-flag-scanner/helpers/scanFile.ts`
**Description:** Code has 7 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Spaghetti Code (HIGH)
**File:** `lib/menu-lock/change-tracking/helpers/getLockedMenusUsingEntity.ts`
**Description:** Code has 7 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Spaghetti Code (HIGH)
**File:** `lib/personality/scheduler.ts`
**Description:** Code has 10 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Magic Numbers (MEDIUM)
**File:** `lib/populate-recipes-data.ts`
**Description:** Found 172 magic numbers
**Suggestion:** Extract magic numbers to named constants
...
### Spaghetti Code (HIGH)
**File:** `lib/rsi/architecture-analysis/index.ts`
**Description:** Code has 9 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Spaghetti Code (HIGH)
**File:** `lib/square/sync/catalog/helpers/processToSquare.ts`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Spaghetti Code (HIGH)
**File:** `lib/square/sync/staff/helpers/processToSquare.ts`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Spaghetti Code (HIGH)
**File:** `components/Arcade/AchievementsDropdown.tsx`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
### Magic Numbers (MEDIUM)
**File:** `components/GlobalWarning.tsx`
**Description:** Found 93 magic numbers
**Suggestion:** Extract magic numbers to named constants
