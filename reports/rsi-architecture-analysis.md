...
**Date:** 1/18/2026, 9:07:56 AM

**Detected Design Patterns:** 7
**Detected Anti-Patterns:** 541
...
**File:** `app/api/admin/features/auto-create/helpers/processHiddenFlags.ts`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions

### Spaghetti Code (HIGH)

**File:** `app/api/admin/features/auto-create/helpers/processRegularFlags.ts`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
**File:** `app/api/allergens/re-aggregate-all/helpers/reAggregateDishes.ts`
...
**File:** `app/api/compliance/health-inspector-report/helpers/checkers/checkEmployeeQualifications.ts`
**Description:** Code has 6 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
**File:** `app/api/ingredients/helpers/update/detectCurrentAllergens.ts`
**Description:** Code has 7 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
**File:** `app/api/prep-lists/generate-from-menu/helpers/processDish/processDishIngredients.ts`
**Description:** Code has 7 levels of nesting
**Suggestion:** Extract nested logic into separate functions
...
**File:** `lib/square/sync/costs/helpers/calculateCost.ts`
**Description:** Code has 7 levels of nesting
**Suggestion:** Extract nested logic into separate functions
