...
type AppRouteHandlerRoutes = "/api/ai-specials" | "/api/all-recipe-ingredients" | "/api/assign-dish-section" | "/api/check-table-structure" | "/api/cleaning-areas" | "/api/cleaning-tasks" | "/api/compliance-records" | "/api/compliance-types" | "/api/create-correct-rls-policies" | "/api/create-rls-policies" | "/api/create-tables" | "/api/create-tables-auto" | "/api/disable-rls" | "/api/fix-database" | "/api/fix-rls-policies" | "/api/generate-test-temperature-logs" | "/api/ingredients" | "/api/kitchen-sections" | "/api/order-lists" | "/api/par-levels" | "/api/performance" | "/api/populate-recipes" | "/api/prep-lists" | "/api/recipe-ingredients" | "/api/recipe-share" | "/api/recipes" | "/api/sample-performance-data" | "/api/send-sample-email" | "/api/setup-database" | "/api/setup-restaurant-features" | "/api/supplier-price-lists" | "/api/suppliers" | "/api/temperature-equipment" | "/api/temperature-logs" | "/api/test-recipe-ingredient" | "/api/test-table-columns"
