...
type AppRouteHandlerRoutes = "/api/ai-specials" | "/api/all-recipe-ingredients" | "/api/assign-dish-section" | "/api/check-all-tables" | "/api/check-table-structure" | "/api/cleaning-areas" | "/api/cleaning-tasks" | "/api/compliance-records" | "/api/compliance-types" | "/api/create-correct-rls-policies" | "/api/create-database-tables" | "/api/create-missing-tables" | "/api/create-rls-policies" | "/api/create-tables" | "/api/create-tables-auto" | "/api/disable-rls" | "/api/enable-rls-security" | "/api/fix-database" | "/api/fix-rls-policies" | "/api/fix-table-structure" | "/api/generate-test-temperature-logs" | "/api/ingredients" | "/api/kitchen-sections" | "/api/menu-dishes" | "/api/order-lists" | "/api/par-levels" | "/api/performance" | "/api/populate-recipes" | "/api/populate-simple-test-data" | "/api/populate-test-data" | "/api/prep-lists" | "/api/recipe-ingredients" | "/api/recipe-share" | "/api/recipes" | "/api/sample-performance-data" | "/api/send-sample-email" | "/api/setup-complete-database" | "/api/setup-database" | "/api/setup-restaurant-features" | "/api/supplier-price-lists" | "/api/suppliers" | "/api/temperature-equipment" | "/api/temperature-logs" | "/api/test-recipe-ingredient" | "/api/test-table-columns"
