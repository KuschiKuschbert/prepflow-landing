...
function COGSPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "COGSPage.useEffect": ()=>{
            const debugRecipes = {
                "COGSPage.useEffect.debugRecipes": async ()=>{
                    try {
                        // First, let's see what columns exist
                        const { data: allRecipes, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('recipes').select('*').limit(3);
                        ...
                        const { data: recipeNames, error: nameError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('recipes').select('name').order('name');
            ...
            }["COGSPage.useEffect.debugRecipes"];
            debugRecipes();
        }
    }["COGSPage.useEffect"], []);
    ...
    const handleSaveAsRecipe = async ()=>{
        ...
        try {
            ...
            if (existingRecipe && !checkError) {
                ...
                const recipePortions = dishPortions || (selectedRecipeData === null || selectedRecipeData === void 0 ? void 0 : selectedRecipeData.yield) || 1;
    ...
    const costPerPortion = dishPortions > 0 ? totalCOGS / dishPortions : (selectedRecipeData === null || selectedRecipeData === void 0 ? void 0 : selectedRecipeData.yield) ? totalCOGS / selectedRecipeData.yield : 0;
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                (dishPortions > 0 || (selectedRecipeData === null || selectedRecipeData === void 0 ? void 0 : selectedRecipeData.yield)) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "flex justify-between items-center mb-4",
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                            className: "text-sm text-gray-400",
...
_s(COGSPage, "+G5dcg5ZWHHG+LrSeharHARkKOw=");
_c = COGSPage;
var _c;
...
//# sourceMappingURL=_fb2e990c._.js.map