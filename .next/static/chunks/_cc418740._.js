...
"[project]/hooks/useCountryFormatting.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useCountryFormatting() {
    _s();
    const { countryConfig } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$contexts$2f$CountryContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCountry"])();
    const formatCurrency = function(amount) {
        let includeTax = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : true;
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$country$2d$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatCurrencyWithTax"])(amount, countryConfig.code, includeTax);
    };
    ...
    const calculateTax = (amount)=>{
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$country$2d$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getTaxBreakdown"])(amount, countryConfig.code);
    };
    const getTaxInfo = ()=>({
...
_s(useCountryFormatting, "o0UVVOtS7w8VWCfOZFOYL9jt2PI=", false, function() {
    return [
...
"[project]/app/webapp/temperature/components/RechartsTemperatureChart.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function RechartsTemperatureChart(param) {
    let { logs, equipment, timeFilter } = param;
    _s();
    ...
    const getFilteredLogs = ()=>{
        ...
        const sortedLogs = equipmentLogs.sort((a, b)=>{
            const dateA = new Date("".concat(a.log_date, "T").concat(a.log_time));
            const dateB = new Date("".concat(b.log_date, "T").concat(b.log_time));
            return dateA.getTime() - dateB.getTime();
        });
        // Apply time filter
        const now = new Date();
        const mostRecentLog = sortedLogs[sortedLogs.length - 1];
        const mostRecentTime = new Date("".concat(mostRecentLog.log_date, "T").concat(mostRecentLog.log_time));
        let cutoffTime;
        switch(timeFilter){
            case '24h':
        ...
        return sortedLogs.filter((log)=>{
            const logTime = new Date("".concat(log.log_date, "T").concat(log.log_time));
    ...
    const chartData = filteredLogs.map((log)=>({
            timestamp: "".concat(log.log_date, "T").concat(log.log_time),
            temperature: log.temperature_celsius,
            time: new Date("".concat(log.log_date, "T").concat(log.log_time)).toLocaleTimeString([], {
                hour: '2-digit',
                minute: '2-digit'
            }),
            date: new Date("".concat(log.log_date, "T").concat(log.log_time)).toLocaleDateString()
        }));
    // Handle loading state
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RechartsTemperatureChart.useEffect": ()=>{
            if (chartData.length > 0 && equipment && equipment.name) {
                const timer = setTimeout({
                    "RechartsTemperatureChart.useEffect.timer": ()=>{
                        setIsLoaded(true);
                    }
                }["RechartsTemperatureChart.useEffect.timer"], 200);
                return ({
                    "RechartsTemperatureChart.useEffect": ()=>clearTimeout(timer)
                })["RechartsTemperatureChart.useEffect"];
            } else {
                setIsLoaded(false);
            }
        ...
        chartData.length,
        equipment === null || equipment === void 0 ? void 0 : equipment.name,
        timeFilter
    ]);
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$recharts$2f$es6$2f$chart$2f$LineChart$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LineChart"], {
                ...
                children: [
                    ...
                    equipment.min_temp_celsius !== null && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$recharts$2f$es6$2f$cartesian$2f$ReferenceLine$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ReferenceLine"], {
                        ...
                        strokeWidth: 2,
                        label: {
                            value: "Min: ".concat(equipment.min_temp_celsius, "°C"),
                    ...
                    equipment.max_temp_celsius !== null && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$recharts$2f$es6$2f$cartesian$2f$ReferenceLine$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ReferenceLine"], {
                        ...
                        strokeWidth: 2,
                        label: {
                            value: "Max: ".concat(equipment.max_temp_celsius, "°C"),
...
_s(RechartsTemperatureChart, "e/1lVN3R6kIvuSIAmUIHNmZXQsc=");
_c = RechartsTemperatureChart;
var _c;
__turbopack_context__.k.register(_c, "RechartsTemperatureChart");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/app/webapp/temperature/components/CleanTemperatureChart.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$webapp$2f$temperature$2f$components$2f$RechartsTemperatureChart$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/webapp/temperature/components/RechartsTemperatureChart.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
;
;
function CleanTemperatureChart(param) {
    let { logs, equipment, timeFilter } = param;
    _s();
    ...
    const getFilteredLogs = ()=>{
        ...
        console.log('🔍 Filter Debug:', {
            ...
            equipmentName: equipment === null || equipment === void 0 ? void 0 : equipment.name,
            equipmentFilteredCount: equipmentFilteredLogs.length,
            timeFilter,
            sampleEquipmentLogs: equipmentFilteredLogs.slice(0, 3)
        });
        console.log('🔍 Filter Debug - Expanded:', 'Total logs:', logs.length, 'Equipment name:', equipment === null || equipment === void 0 ? void 0 : equipment.name, 'Equipment filtered count:', equipmentFilteredLogs.length, 'Time filter:', timeFilter, 'Sample logs:', equipmentFilteredLogs.slice(0, 3));
            ...
            case '24h':
                ...
                if (equipmentFilteredLogs.length > 0) {
                    const mostRecentLog = equipmentFilteredLogs.reduce((latest, log)=>{
                        const logDate = new Date("".concat(log.log_date, " ").concat(log.log_time));
                        const latestDate = new Date("".concat(latest.log_date, " ").concat(latest.log_time));
                        return logDate > latestDate ? log : latest;
                    });
                    const mostRecentDate = new Date("".concat(mostRecentLog.log_date, " ").concat(mostRecentLog.log_time));
    ...
    const filteredLogs = getFilteredLogs();
    const chartData = filteredLogs.map((log)=>{
        const timestamp = "".concat(log.log_date, " ").concat(log.log_time);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CleanTemperatureChart.useEffect": ()=>{
    ...
    const getSmartAlerts = ()=>{
        ...
        const recentLogs = filteredLogs.filter((log)=>{
            const logTime = new Date("".concat(log.log_date, " ").concat(log.log_time));
    ...
    const formatTooltipLabel = (label)=>{
        ...
        return "".concat(date.getDate(), " ").concat(months[date.getMonth()], " ").concat(date.getFullYear(), ", ").concat(hours, ":").concat(minutes);
    };
    const formatTooltipValue = (value)=>{
        return "".concat(value === null || value === void 0 ? void 0 : value.toFixed(1), "°C");
    };
    // Clean up event listeners
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CleanTemperatureChart.useEffect": ()=>{
            const handleGlobalMouseUp = {
                "CleanTemperatureChart.useEffect.handleGlobalMouseUp": ()=>{
                // Handle mouse up events if needed
                }
            }["CleanTemperatureChart.useEffect.handleGlobalMouseUp"];
            const handleGlobalTouchEnd = {
                "CleanTemperatureChart.useEffect.handleGlobalTouchEnd": ()=>{
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "w-2 h-2 rounded-full ".concat(statusColor.replace('text-', 'bg-'))
                                }, void 0, false, {
                                    fileName: "[project]/app/webapp/temperature/components/CleanTemperatureChart.tsx",
                                    lineNumber: 361,
                                    columnNumber: 13
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    className: "text-sm ".concat(statusColor),
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            hasRecentOutOfRange && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: latestTemperature ? "".concat(latestTemperature.toFixed(1), "°C") : '--'
            }, void 0, false, {
                fileName: "[project]/app/webapp/temperature/components/CleanTemperatureChart.tsx",
                lineNumber: 411,
                columnNumber: 7
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                children: [
                                    ...
                                    chartData.length,
                                    " readings",
                                    adaptiveSettings.shouldSample && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "flex items-center space-x-1 ".concat(dailyCompliance.hasMinimumLogs ? 'text-green-400' : 'text-red-400'),
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "flex items-center space-x-1 ".concat(dailyCompliance.hasFoodTemp ? 'text-green-400' : 'text-yellow-400'),
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                            ...
                            dailyCompliance.lastLogTime && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                    ...
                    smartAlerts.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "mt-2 space-y-1",
                        children: smartAlerts.map((alert, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "flex items-center space-x-2 px-2 py-1 rounded text-xs ".concat(alert.type === 'critical' ? 'bg-red-500/10 text-red-400 border border-red-500/20' : alert.type === 'warning' ? 'bg-yellow-500/10 text-yellow-400 border border-yellow-500/20' : 'bg-blue-500/10 text-blue-400 border border-blue-500/20'),
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        children: alert.icon
                                    }, void 0, false, {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "w-full",
                style: {
                    height: "".concat(adaptiveSettings.chartHeight, "px")
                },
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$webapp$2f$temperature$2f$components$2f$RechartsTemperatureChart$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                    logs: logs,
                    equipment: equipment,
...
_s(CleanTemperatureChart, "laaY0S6fWX8fioZtZnxEGXDUJSk=");
_c = CleanTemperatureChart;
var _c;
__turbopack_context__.k.register(_c, "CleanTemperatureChart");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/app/webapp/temperature/components/TemperatureAnalyticsTab.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$webapp$2f$temperature$2f$components$2f$CleanTemperatureChart$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/webapp/temperature/components/CleanTemperatureChart.tsx [app-client] (ecmascript)");
...
;
;
function TemperatureAnalyticsTab(param) {
    ...
    const [timeFilter, setTimeFilter] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('24h');
    const [dateOffset, setDateOffset] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0); // 0 for today, 1 for yesterday, etc.
    const [isLoaded, setIsLoaded] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [selectedEquipmentId, setSelectedEquipmentId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [hasManuallyChangedFilter, setHasManuallyChangedFilter] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    // Handle loading state to prevent FOUC - wait for data to be ready
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TemperatureAnalyticsTab.useEffect": ()=>{
    ...
    const getFilteredLogs = (equipment)=>{
        ...
        const selectedDateString = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(today, 'yyyy-MM-dd');
        if (timeFilter === '24h') {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: isLoaded ? [
                    ...
                    'all'
                        ...
                        className: "px-4 py-2 rounded-xl text-sm font-medium transition-colors ".concat(timeFilter === filter ? 'bg-[#29E7CD] text-black' : 'bg-transparent text-gray-400 hover:text-white hover:bg-[#2a2a2a]'),
                        children: t("timeFilter.".concat(filter), filter === '24h' ? 'Last 24h' : filter === '7d' ? 'Last 7 Days' : filter === '30d' ? 'Last 30 Days' : 'All Time')
                    }, filter, false, {
                        fileName: "[project]/app/webapp/temperature/components/TemperatureAnalyticsTab.tsx",
                        lineNumber: 186,
                        columnNumber: 13
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "grid gap-3 ".concat(equipment.length <= 2 ? 'grid-cols-1 sm:grid-cols-2' : equipment.length <= 4 ? 'grid-cols-1 sm:grid-cols-2 lg:grid-cols-4' : equipment.length <= 6 ? 'grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6' : equipment.length <= 12 ? 'grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6' : 'grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6'),
                children: isLoaded ? equipment.map((item)=>{
                    ...
                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        ...
                        className: "group bg-[#1f1f1f] rounded-xl shadow-lg border transition-all duration-300 hover:shadow-xl hover:-translate-y-0.5 text-left w-full ".concat(isCompact ? 'p-3' : 'p-4', " ").concat(isSelected ? 'border-[#29E7CD] ring-2 ring-[#29E7CD]/20 bg-[#29E7CD]/5' : isOutOfRange ? 'border-red-500/50 hover:border-red-500' : needsSetup ? 'border-yellow-500/50 hover:border-yellow-500' : 'border-[#2a2a2a] hover:border-[#29E7CD]/50'),
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "flex items-center justify-between ".concat(isCompact ? 'mb-2' : 'mb-3'),
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "flex-1 min-w-0",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                            className: "font-semibold text-white truncate group-hover:text-[#29E7CD] transition-colors ".concat(isCompact ? 'text-xs' : 'text-sm'),
                                            children: item.name
                                        }, void 0, false, {
                                            fileName: "[project]/app/webapp/temperature/components/TemperatureAnalyticsTab.tsx",
                                            lineNumber: 240,
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "rounded-full ".concat(isCompact ? 'w-1 h-1' : 'w-1.5 h-1.5', " ").concat(isOutOfRange ? 'bg-red-500' : needsSetup ? 'bg-yellow-500' : 'bg-green-500')
                                                }, void 0, false, {
                                                    fileName: "[project]/app/webapp/temperature/components/TemperatureAnalyticsTab.tsx",
                                                    lineNumber: 246,
                                                    columnNumber: 21
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                    className: "font-medium ".concat(isCompact ? 'text-xs' : 'text-xs', " ").concat(isOutOfRange ? 'text-red-400' : needsSetup ? 'text-yellow-400' : 'text-green-400'),
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "font-bold text-white ".concat(isCompact ? 'text-lg mb-1' : 'text-2xl mb-1'),
                                        children: status.temperature ? "".concat(status.temperature.toFixed(1), "°C") : '--'
                                    }, void 0, false, {
                                        fileName: "[project]/app/webapp/temperature/components/TemperatureAnalyticsTab.tsx",
                                        lineNumber: 270,
                                        columnNumber: 17
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            logs.length,
                                            " readings ",
                                            isCompact ? '' : "• ".concat(timeFilter.toUpperCase())
                                        ]
                                    }, void 0, true, {
                                        fileName: "[project]/app/webapp/temperature/components/TemperatureAnalyticsTab.tsx",
                                        lineNumber: 273,
                            ...
                            !isCompact && (isOutOfRange || needsSetup) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "pt-3 border-t border-[#2a2a2a]",
                                children: [
                                    isOutOfRange && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    needsSetup && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            isCompact && isOutOfRange && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$LoadingSkeleton$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LoadingSkeleton"], {
                ...
                lineNumber: 313,
                columnNumber: 9
            }, this) : equipment.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                lineNumber: 315,
                columnNumber: 9
            }, this) : selectedEquipmentId ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "chart-container",
                children: (()=>{
                    const selectedEquipment = getSelectedEquipment();
                    if (!selectedEquipment) return null;
                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$webapp$2f$temperature$2f$components$2f$CleanTemperatureChart$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
...
_s(TemperatureAnalyticsTab, "HvittIkqv09gnif9Vuon11w3CW8=", false, function() {
    return [
...
_c = TemperatureAnalyticsTab;
var _c;
__turbopack_context__.k.register(_c, "TemperatureAnalyticsTab");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$LoadingSkeleton$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/ui/LoadingSkeleton.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$webapp$2f$temperature$2f$components$2f$TemperatureAnalyticsTab$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/webapp/temperature/components/TemperatureAnalyticsTab.tsx [app-client] (ecmascript)");
...
const TemperatureLogsTab = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$shared$2f$lib$2f$app$2d$dynamic$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(()=>__turbopack_context__.A("[project]/app/webapp/temperature/components/TemperatureLogsTab.tsx [app-client] (ecmascript, next/dynamic entry, async loader)"), {
    loadableGenerated: {
        modules: [
            "[project]/app/webapp/temperature/components/TemperatureLogsTab.tsx [app-client] (ecmascript, next/dynamic entry)"
        ]
    },
...
const TemperatureEquipmentTab = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$shared$2f$lib$2f$app$2d$dynamic$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(()=>__turbopack_context__.A("[project]/app/webapp/temperature/components/TemperatureEquipmentTab.tsx [app-client] (ecmascript, next/dynamic entry, async loader)"), {
    loadableGenerated: {
        modules: [
            "[project]/app/webapp/temperature/components/TemperatureEquipmentTab.tsx [app-client] (ecmascript, next/dynamic entry)"
        ]
    },
    loading: ()=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$LoadingSkeleton$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LoadingSkeleton"], {
            variant: "table",
...
function TemperatureLogsPage() {
    ...
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false); // Start with false to prevent skeleton showing
    const [isInitialLoad, setIsInitialLoad] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false); // Start with false to prevent skeleton flash
    ...
    const [quickTempLoading, setQuickTempLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
            ...
            if (data.success) {
                ...
                if (data.data.length === 0 && allLogs.length > 0) {
                    ...
                    if (datesWithLogs.length > 0) {
                        ...
                        console.log("No data for ".concat(selectedDate, ", switching to ").concat(mostRecentDate));
                        setSelectedDate(mostRecentDate);
                        // Fetch logs for the most recent date
                        const fallbackUrl = "/api/temperature-logs?date=".concat(mostRecentDate).concat(selectedType !== 'all' ? "&type=".concat(selectedType) : '');
    ...
    const handleDeleteLog = async (logId)=>{
        try {
            const response = await fetch("/api/temperature-logs/".concat(logId), {
                method: 'DELETE'
            });
            const data = await response.json();
            if (data.success) {
    ...
    const handleUpdateEquipment = async (equipmentId, updates)=>{
        try {
            const response = await fetch("/api/temperature-equipment/".concat(equipmentId), {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json'
                },
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                className: "px-6 py-3 rounded-xl font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#29E7CD] focus:ring-offset-2 focus:ring-offset-[#0a0a0a] ".concat(activeTab === 'logs' ? 'bg-[#29E7CD] text-black shadow-lg' : 'text-gray-400 hover:text-white'),
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                className: "px-6 py-3 rounded-xl font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#29E7CD] focus:ring-offset-2 focus:ring-offset-[#0a0a0a] ".concat(activeTab === 'equipment' ? 'bg-[#29E7CD] text-black shadow-lg' : 'text-gray-400 hover:text-white'),
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                className: "px-6 py-3 rounded-xl font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#29E7CD] focus:ring-offset-2 focus:ring-offset-[#0a0a0a] ".concat(activeTab === 'analytics' ? 'bg-[#29E7CD] text-black shadow-lg' : 'text-gray-400 hover:text-white'),
                ...
                activeTab === 'logs' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(TemperatureLogsTab, {
                    logs: logs,
                    equipment: equipment,
                ...
                activeTab === 'equipment' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(TemperatureEquipmentTab, {
                    equipment: equipment,
...
_c2 = TemperatureLogsPage;
var _c, _c1, _c2;
__turbopack_context__.k.register(_c, "TemperatureLogsTab");
__turbopack_context__.k.register(_c1, "TemperatureEquipmentTab");
__turbopack_context__.k.register(_c2, "TemperatureLogsPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_cc418740._.js.map