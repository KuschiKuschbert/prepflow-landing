...
"[project]/app/webapp/recipes/hooks/useRecipeManagement.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useRecipeManagement() {
    ...
    const calculateRecommendedPrice = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useRecipeManagement.useCallback[calculateRecommendedPrice]": (recipe, ingredients)=>{
            if (!ingredients || ingredients.length === 0) return null;
            // Calculate total cost per serving
            let totalCostPerServing = 0;
            ingredients.forEach({
                "useRecipeManagement.useCallback[calculateRecommendedPrice]": (ri)=>{
            ...
            }["useRecipeManagement.useCallback[calculateRecommendedPrice]"]);
    ...
    const fetchRecipes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useRecipeManagement.useCallback[fetchRecipes]": async ()=>{
            try {
    ...
    }["useRecipeManagement.useCallback[fetchRecipes]"], []);
    // Calculate prices for all recipes
    const calculateAllRecipePrices = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useRecipeManagement.useCallback[calculateAllRecipePrices]": async (recipesData)=>{
            const prices = {};
    ...
    }["useRecipeManagement.useCallback[calculateAllRecipePrices]"], [
        calculateRecommendedPrice
    ]);
    // Refresh recipe prices (for auto-updates)
    const refreshRecipePrices = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useRecipeManagement.useCallback[refreshRecipePrices]": async ()=>{
    ...
    }["useRecipeManagement.useCallback[refreshRecipePrices]"], [
        recipes,
    ...
    const fetchRecipeIngredients = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useRecipeManagement.useCallback[fetchRecipeIngredients]": async (recipeId)=>{
            try {
    ...
    }["useRecipeManagement.useCallback[fetchRecipeIngredients]"], []);
    const handleEditRecipe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useRecipeManagement.useCallback[handleEditRecipe]": async (recipe)=>{
            try {
                // Fetch recipe ingredients
                const ingredients = await fetchRecipeIngredients(recipe.id);
                // Convert to COGSCalculation format
                const calculations = ingredients.map({
                    "useRecipeManagement.useCallback[handleEditRecipe].calculations": (ri)=>{
                        const ingredient = ri.ingredients;
                        const quantity = ri.quantity;
                ...
                }["useRecipeManagement.useCallback[handleEditRecipe].calculations"]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useRecipeManagement.useEffect": ()=>{
            ...
            const subscription = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].channel('ingredient-price-changes').on('postgres_changes', {
                ...
                "useRecipeManagement.useEffect.subscription": (payload)=>{
                    console.log('Ingredient price changed:', payload);
                    // Refresh recipe prices when any ingredient price changes
                    refreshRecipePrices();
                }
            }["useRecipeManagement.useEffect.subscription"]).subscribe();
            return ({
                "useRecipeManagement.useEffect": ()=>{
...
_s(useRecipeManagement, "J0q20m2Kme58/3jvBFOn3J6Db1k=", false, function() {
    return [
...
"[project]/app/webapp/recipes/hooks/useAIInstructions.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useAIInstructions() {
    ...
    const generateAIInstructions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAIInstructions.useCallback[generateAIInstructions]": async (recipe, ingredients)=>{
            ...
            try {
                ...
                const ingredientNames = ingredients.map({
                    "useAIInstructions.useCallback[generateAIInstructions].ingredientNames": (ri)=>ri.ingredients.ingredient_name.toLowerCase()
                }["useAIInstructions.useCallback[generateAIInstructions].ingredientNames"]);
                console.log('🤖 DEBUG: Ingredient names:', ingredientNames);
                const hasProtein = ingredientNames.some({
                    "useAIInstructions.useCallback[generateAIInstructions].hasProtein": (name)=>name.includes('beef') || name.includes('chicken') || name.includes('pork') || name.includes('fish') || name.includes('lamb') || name.includes('mince')
                }["useAIInstructions.useCallback[generateAIInstructions].hasProtein"]);
                const hasVegetables = ingredientNames.some({
                    "useAIInstructions.useCallback[generateAIInstructions].hasVegetables": (name)=>name.includes('carrot') || name.includes('onion') || name.includes('garlic') || name.includes('tomato') || name.includes('pepper') || name.includes('celery')
                }["useAIInstructions.useCallback[generateAIInstructions].hasVegetables"]);
                const hasDairy = ingredientNames.some({
                    "useAIInstructions.useCallback[generateAIInstructions].hasDairy": (name)=>name.includes('cheese') || name.includes('milk') || name.includes('cream') || name.includes('butter') || name.includes('yogurt')
                }["useAIInstructions.useCallback[generateAIInstructions].hasDairy"]);
                const hasGrains = ingredientNames.some({
                    "useAIInstructions.useCallback[generateAIInstructions].hasGrains": (name)=>name.includes('rice') || name.includes('pasta') || name.includes('bread') || name.includes('flour') || name.includes('quinoa')
                }["useAIInstructions.useCallback[generateAIInstructions].hasGrains"]);
    ...
    }["useAIInstructions.useCallback[generateAIInstructions]"], []);
    return {
        aiInstructions,
...
_s(useAIInstructions, "DmwQ01kVOcjHQIfGYT7+3JZoJhQ=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/app/webapp/recipes/components/RecipeCard.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function RecipeCard(param) {
    let { recipe, recipePrices, selectedRecipes, onSelectRecipe, onPreviewRecipe, onEditRecipe, onDeleteRecipe, capitalizeRecipeName } = param;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
"[project]/app/webapp/recipes/components/RecipeTable.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
'use client';
;
function RecipeTable(param) {
    let { recipes, recipePrices, selectedRecipes, onSelectAll, onSelectRecipe, onPreviewRecipe, onEditRecipe, onDeleteRecipe, capitalizeRecipeName } = param;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_c = RecipeTable;
var _c;
__turbopack_context__.k.register(_c, "RecipeTable");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/app/webapp/recipes/components/RecipeForm.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
'use client';
;
function RecipeForm(param) {
    let { showForm, newRecipe, onToggleForm, onUpdateRecipe, onSubmit } = param;
...
"[project]/app/webapp/recipes/components/BulkActionsBar.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
'use client';
;
function BulkActionsBar(param) {
    let { selectedCount, onBulkDelete, onClearSelection } = param;
...
"[project]/app/webapp/recipes/components/RecipePreviewModal.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
'use client';
;
function RecipePreviewModal(param) {
    let { showPreview, selectedRecipe, recipeIngredients, aiInstructions, generatingInstructions, previewYield, shareLoading, onClose, onEditFromPreview, onShareRecipe, onPrint, onUpdatePreviewYield, capitalizeRecipeName, formatQuantity } = param;
...
_c = RecipePreviewModal;
var _c;
__turbopack_context__.k.register(_c, "RecipePreviewModal");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$webapp$2f$recipes$2f$hooks$2f$useRecipeManagement$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/webapp/recipes/hooks/useRecipeManagement.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$webapp$2f$recipes$2f$hooks$2f$useAIInstructions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/webapp/recipes/hooks/useAIInstructions.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$webapp$2f$recipes$2f$components$2f$RecipeCard$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/webapp/recipes/components/RecipeCard.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$webapp$2f$recipes$2f$components$2f$RecipeTable$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/webapp/recipes/components/RecipeTable.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$webapp$2f$recipes$2f$components$2f$RecipeForm$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/webapp/recipes/components/RecipeForm.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$webapp$2f$recipes$2f$components$2f$BulkActionsBar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/webapp/recipes/components/BulkActionsBar.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$webapp$2f$recipes$2f$components$2f$RecipePreviewModal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/webapp/recipes/components/RecipePreviewModal.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
function RecipesPageContent() {
    _s();
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const { recipes, loading, error, recipePrices, capitalizeRecipeName, fetchRecipes, fetchRecipeIngredients, handleEditRecipe, setError } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$webapp$2f$recipes$2f$hooks$2f$useRecipeManagement$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRecipeManagement"])();
    const { aiInstructions, generatingInstructions, generateAIInstructions } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$webapp$2f$recipes$2f$hooks$2f$useAIInstructions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAIInstructions"])();
    // Form state
    ...
    const formatQuantity = (quantity, unit)=>{
        const adjustedQuantity = previewYield / ((selectedRecipe === null || selectedRecipe === void 0 ? void 0 : selectedRecipe.yield) || 1) * quantity;
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$webapp$2f$recipes$2f$components$2f$BulkActionsBar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$webapp$2f$recipes$2f$components$2f$RecipeForm$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "divide-y divide-[#2a2a2a]",
                                children: recipes.map((recipe)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$webapp$2f$recipes$2f$components$2f$RecipeCard$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                        recipe: recipe,
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$webapp$2f$recipes$2f$components$2f$RecipeTable$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                            recipes: recipes,
                            recipePrices: recipePrices,
                            selectedRecipes: selectedRecipes,
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$webapp$2f$recipes$2f$components$2f$RecipePreviewModal$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
...
_s(RecipesPageContent, "jNiKFtGC5HxAhkysHxaskWdzOXY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$webapp$2f$recipes$2f$hooks$2f$useRecipeManagement$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRecipeManagement"],
        __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$webapp$2f$recipes$2f$hooks$2f$useAIInstructions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAIInstructions"]
    ];
});
_c = RecipesPageContent;
function RecipesPageRefactored() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$ErrorBoundary$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ErrorBoundary"], {
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(RecipesPageContent, {}, void 0, false, {
            fileName: "[project]/app/webapp/recipes/page.tsx",
            lineNumber: 679,
            columnNumber: 7
        }, this)
...
_c1 = RecipesPageRefactored;
var _c, _c1;
__turbopack_context__.k.register(_c, "RecipesPageContent");
__turbopack_context__.k.register(_c1, "RecipesPageRefactored");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_fc9949be._.js.map