...
const handleApiError = (error)=>{
    ...
    // HTTP errors
    const status = ((_error_response = error.response) === null || _error_response === void 0 ? void 0 : _error_response.status) || 500;
    const data = (_error_response1 = error.response) === null || _error_response1 === void 0 ? void 0 : _error_response1.data;
    switch(status){
        case 400:
            return {
                message: (data === null || data === void 0 ? void 0 : data.message) || 'Invalid request',
                code: 'BAD_REQUEST',
                status: 400,
                details: data
            };
        ...
        case 500:
            return {
                message: (data === null || data === void 0 ? void 0 : data.message) || 'Internal server error',
                code: 'SERVER_ERROR',
                status: 500,
                details: data
            };
        default:
            return {
                message: (data === null || data === void 0 ? void 0 : data.message) || 'An unexpected error occurred',
                code: 'UNKNOWN_ERROR',
                status,
                details: data
            };
...
const retryApiCall = async function(apiCall) {
...
const useApiErrorHandler = ()=>{
    const handleError = (error, context)=>{
        console.error("API Error".concat(context ? " in ".concat(context) : '', ":"), error);
        // Log to analytics if available
        if ("object" !== 'undefined' && window.gtag) {
...
"[project]/hooks/useApiCall.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useApiCall(apiFunction) {
    ...
    const execute = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useApiCall.useCallback[execute]": async function() {
            ...
            setError(null);
            try {
                const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["withErrorHandling"])({
                    "useApiCall.useCallback[execute]": ()=>apiFunction(...args)
...
_s(useApiCall, "e8XkO2Dh/yoC/HxncT1+LE3WoQ0=");
function useApiCalls(apiFunctions) {
    let options = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    _s1();
    const [results, setResults] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [errors, setErrors] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const executeAll = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useApiCalls.useCallback[executeAll]": async function() {
            for(var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++){
                args[_key] = arguments[_key];
            }
            setLoading(true);
            setErrors([]);
            try {
                const promises = apiFunctions.map({
                    "useApiCalls.useCallback[executeAll].promises": (apiFunction)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$error$2d$handler$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["withErrorHandling"])({
                            "useApiCalls.useCallback[executeAll].promises": ()=>apiFunction(...args)
                        }["useApiCalls.useCallback[executeAll].promises"])
                }["useApiCalls.useCallback[executeAll].promises"]);
                const results = await Promise.all(promises);
                setResults(results);
                setErrors(results.map({
                    "useApiCalls.useCallback[executeAll]": (result)=>result.error || null
                }["useApiCalls.useCallback[executeAll]"]));
                return results;
            } catch (err) {
                const apiError = {
                    message: 'An unexpected error occurred',
                ...
                const errorResults = apiFunctions.map({
                    "useApiCalls.useCallback[executeAll].errorResults": ()=>({
                            success: false,
                            error: apiError
                        })
                }["useApiCalls.useCallback[executeAll].errorResults"]);
                setResults(errorResults);
                setErrors(apiFunctions.map({
                    "useApiCalls.useCallback[executeAll]": ()=>apiError
                }["useApiCalls.useCallback[executeAll]"]));
                return errorResults;
            } finally{
                setLoading(false);
...
_s1(useApiCalls, "NIIpPBxqhY0r4GtZMUDfg7aMbFk=");
function useCachedApiCall(apiFunction, cacheKey) {
    let options = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
    _s2();
    const { cacheTimeout = 5 * 60 * 1000 } = options; // 5 minutes default
    const apiCall = useApiCall(apiFunction, options);
    const executeWithCache = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useCachedApiCall.useCallback[executeWithCache]": async function() {
            for(var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++){
                args[_key] = arguments[_key];
            }
            const cacheKeyWithArgs = "".concat(cacheKey, "_").concat(JSON.stringify(args));
    ...
    }["useCachedApiCall.useCallback[executeWithCache]"], [
        apiCall,
        cacheKey,
        cacheTimeout
    ]);
...
_s2(useCachedApiCall, "TVac+wZZQ0eRQJInhh+nhCNohAc=", false, function() {
    return [
        useApiCall
    ];
});
...
"[project]/components/ui/ApiErrorDisplay.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
'use client';
;
const ApiErrorDisplay = (param)=>{
    let { error, context, onRetry, className = '' } = param;
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "bg-[#1f1f1f] p-6 rounded-3xl shadow-lg border border-[#2a2a2a] max-w-md mx-auto ".concat(className),
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "flex items-center justify-center mb-4",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "w-12 h-12 rounded-full bg-gradient-to-r ".concat(getErrorColor(error.code), " flex items-center justify-center"),
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                className: "text-xl font-semibold text-white mb-2 text-center",
                children: context ? "".concat(context, " Error") : 'API Error'
            }, void 0, false, {
                fileName: "[project]/components/ui/ApiErrorDisplay.tsx",
                lineNumber: 71,
                columnNumber: 7
            ...
            error.code && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            ("TURBOPACK compile-time value", "development") === 'development' && error.details && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("details", {
                className: "mt-4 p-3 bg-[#2a2a2a] rounded-xl",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("summary", {
                        className: "text-gray-400 cursor-pointer",
...
var _c;
__turbopack_context__.k.register(_c, "ApiErrorDisplay");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useApiCall$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/hooks/useApiCall.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$ApiErrorDisplay$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/ui/ApiErrorDisplay.tsx [app-client] (ecmascript)");
...
function RecentActivity() {
    ...
    const { data: activities, loading, error, execute: refetch } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useApiCall$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useApiCall"])(fetchRecentActivity, {
        immediate: true
    });
    ...
    // Show error state
    if (error) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$ApiErrorDisplay$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ApiErrorDisplay"], {
            error: error,
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "space-y-4",
                children: activities.slice(0, 5).map((activity)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "flex items-center space-x-4 p-3 rounded-2xl bg-[#2a2a2a]/30 hover:bg-[#2a2a2a]/50 transition-colors duration-200",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "flex-shrink-0",
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "w-10 h-10 rounded-full flex items-center justify-center ".concat(activity.type === 'ingredient' ? 'bg-blue-500/20' : activity.type === 'recipe' ? 'bg-green-500/20' : 'bg-purple-500/20'),
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("svg", {
                                        className: "w-5 h-5 ".concat(activity.type === 'ingredient' ? 'text-blue-400' : activity.type === 'recipe' ? 'text-green-400' : 'text-purple-400'),
                                        fill: "none",
                                        stroke: "currentColor",
                                        viewBox: "0 0 24 24",
                                        children: [
                                            activity.type === 'ingredient' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("path", {
                                                strokeLinecap: "round",
                                                strokeLinejoin: "round",
                                                strokeWidth: 2,
                                            ...
                                            activity.type === 'recipe' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("path", {
                                                strokeLinecap: "round",
                                                strokeLinejoin: "round",
                                                strokeWidth: 2,
                                            ...
                                            activity.type === 'menu_dish' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("path", {
                                                strokeLinecap: "round",
                                                strokeLinejoin: "round",
                                                strokeWidth: 2,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "flex-shrink-0",
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    className: "px-2 py-1 rounded-full text-xs font-medium ".concat(activity.type === 'ingredient' ? 'bg-blue-500/20 text-blue-400' : activity.type === 'recipe' ? 'bg-green-500/20 text-green-400' : 'bg-purple-500/20 text-purple-400'),
...
_s(RecentActivity, "gl10SoPPMViRfT8qjIj6x6i89jM=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$useTranslation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTranslation"],
        __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useApiCall$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useApiCall"]
    ];
});
_c = RecentActivity;
var _c;
...
function WebAppDashboardContent() {
    ...
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false); // Completely disabled to prevent skeleton flashes
...
function WebAppDashboard() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$ErrorBoundary$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ErrorBoundary"], {
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(WebAppDashboardContent, {}, void 0, false, {
            fileName: "[project]/app/webapp/page.tsx",
            lineNumber: 163,
            columnNumber: 7
        }, this)
...
__turbopack_context__.k.register(_c1, "WebAppDashboard");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_6fd8ef0a._.js.map