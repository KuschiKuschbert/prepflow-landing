...
"[project]/.next-internal/server/app/api/check-table-structure/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
...
"[project]/app/api/check-table-structure/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
    ...
    try {
        ...
        for (const tableName of tables){
            try {
                ...
                const { data, error } = await supabaseAdmin.from('information_schema.columns').select('column_name, data_type, is_nullable, column_default').eq('table_name', tableName).eq('table_schema', 'public').order('ordinal_position');
                if (error) {
                    results.push({
                        table: tableName,
                        status: 'error',
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c3b601a8._.js.map