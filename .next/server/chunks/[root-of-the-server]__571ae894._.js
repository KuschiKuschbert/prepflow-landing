...
"[project]/.next-internal/server/app/api/all-recipe-ingredients/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
...
"[project]/app/api/all-recipe-ingredients/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const { data: recipeIngredients, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('recipe_ingredients').select('*').limit(10);
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__571ae894._.js.map