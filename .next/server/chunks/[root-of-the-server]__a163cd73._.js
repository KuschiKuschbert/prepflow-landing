...
"[project]/.next-internal/server/app/api/compliance-records/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
...
"[project]/app/api/compliance-records/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        let query = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('compliance_records').select(`
        *,
        compliance_types (
          id,
          name,
...
async function POST(request) {
    try {
        ...
        const { compliance_type_id, document_name, issue_date, expiry_date, document_url, photo_url, notes, reminder_enabled, reminder_days_before } = body;
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('compliance_records').insert({
            compliance_type_id,
            document_name,
...
async function PUT(request) {
    try {
        const body = await request.json();
        const { id, document_name, issue_date, expiry_date, document_url, photo_url, notes, reminder_enabled, reminder_days_before } = body;
        if (!id) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('compliance_records').update(updateData).eq('id', id).select(`
        *,
        compliance_types (
          id,
          name,
...
async function DELETE(request) {
    try {
        ...
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('compliance_records').delete().eq('id', id);
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a163cd73._.js.map