module.exports = [
"[project]/.next-internal/server/app/api/menu-dishes/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/app/api/menu-dishes/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const { data: menuDishes, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('menu_dishes').select('*').order('name');
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f830d2bc._.js.map