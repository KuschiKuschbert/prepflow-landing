module.exports = [
"[project]/.next-internal/server/app/api/ingredients/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
async function GET(request) {
    try {
        ...
        const { data, error } = await supabaseAdmin.from('ingredients').select('*').order('ingredient_name');
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7fae1841._.js.map