...
function COGSPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        if (editingData) {
            try {
                ...
                const recipeIngredientsData = calculations.map((calc)=>({
    ...
    const fetchRecipeIngredients = async ()=>{
        ...
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('recipe_ingredients').select('*').eq('recipe_id', selectedRecipe);
            if (error) {
    ...
    const loadExistingRecipeIngredients = async (recipeId)=>{
        ...
        `).eq('recipe_id', recipeId);
            ...
            const { data: recipeData } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('recipes').select('yield').eq('id', recipeId).single();
            if (recipeData) {
    ...
    // Debug: Log all recipes when component mounts
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const debugRecipes = async ()=>{
            try {
                // First, let's see what columns exist
                const { data: allRecipes, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('recipes').select('*').limit(3);
                console.log('All recipes in database (full structure):', allRecipes);
                if (error) console.log('Error fetching recipes:', error);
                // Also try to get just the names
                const { data: recipeNames, error: nameError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('recipes').select('name').order('name');
                console.log('Recipe names only:', recipeNames);
                if (nameError) console.log('Error fetching recipe names:', nameError);
            } catch (err) {
                console.log('Error in debug recipes:', err);
            }
        };
        debugRecipes();
    }, []);
    ...
    const convertUnit = (value, fromUnit, toUnit, ingredientName)=>{
        ...
        // Weight to Weight conversions (in grams)
        ...
        // Get density for ingredient
        const getDensity = (ingredient)=>{
            if (!ingredient) return densities.default;
        ...
        // Convert to teaspoons first (base unit for volume)
        let teaspoons = 0;
        if (volumeConversions[from]) {
            teaspoons = value * volumeConversions[from];
        } else if (weightConversions[from]) {
            // Weight to volume conversion
            const density = getDensity(ingredientName || '');
            const ml = value / density;
            teaspoons = ml / volumeConversions.ml;
        } else {
            return value; // Unknown unit
        }
        // Convert from teaspoons to target unit
        if (volumeConversions[to]) {
            return teaspoons / volumeConversions[to];
        } else if (weightConversions[to]) {
            // Volume to weight conversion
            const density = getDensity(ingredientName || '');
            const ml = teaspoons * volumeConversions.ml;
            const grams = ml * density;
            return grams / weightConversions[to];
        }
        return value; // Unknown target unit
    };
    const handleSaveAsRecipe = async ()=>{
        ...
        try {
            ...
            if (existingRecipe && !checkError) {
                ...
                const recipePortions = dishPortions || selectedRecipeData?.yield || 1;
        ...
        try {
            ...
            if (existingIngredient) {
                ...
                if (selectedIngredientData) {
                    ...
                    const ingredientUnit = selectedIngredientData.unit.toLowerCase().trim();
                    // Volume units
                    const volumeUnits = [
                        'tsp',
                        'teaspoon',
                    ...
                    if (isUserVolume && isIngredientWeight || isUserWeight && isIngredientVolume) {
                        convertedQuantity = convertUnit(newIngredient.quantity, newIngredient.unit || 'kg', selectedIngredientData.unit, selectedIngredientData.ingredient_name);
                        convertedUnit = selectedIngredientData.unit;
                ...
                if (selectedIngredientData) {
                    ...
                    const costPerUnit = selectedIngredientData.cost_per_unit;
                    const totalCost = quantity * costPerUnit;
                    // Apply waste and yield adjustments
    ...
    const costPerPortion = dishPortions > 0 ? totalCOGS / dishPortions : selectedRecipeData?.yield ? totalCOGS / selectedRecipeData.yield : 0;
                    ...
                    children: [
                                    ...
                                    children: [
                                        ...
                                        dishName.trim() && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: checkingRecipe ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                lineNumber: 1149,
                                                columnNumber: 19
                                            }, this) : recipeExists === true ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                lineNumber: 1154,
                                                columnNumber: 19
                                            }, this) : recipeExists === false ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                calculations.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "space-y-4",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                (dishPortions > 0 || selectedRecipeData?.yield) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "flex justify-between items-center mb-4",
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                            className: "text-sm text-gray-400",
                                                ...
                                                costPerPortion > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__41ba0d4f._.js.map