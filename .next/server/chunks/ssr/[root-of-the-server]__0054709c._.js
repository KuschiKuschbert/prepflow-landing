...
function RecentActivity() {
    ...
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false); // Disable smart loading to prevent skeleton flashes
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const fetchRecentActivity = async ()=>{
            ...
            try {
                ...
                const allActivities = [
                    ...(ingredients || []).filter((item)=>item && typeof item === 'object' && 'id' in item).map((item)=>({
                            id: String(item.id),
                            type: 'ingredient',
                    ...
                    ...(recipes || []).filter((item)=>item && typeof item === 'object' && 'id' in item).map((item)=>({
                            id: String(item.id),
                            type: 'recipe',
                    ...
                    ...(menuDishes || []).filter((item)=>item && typeof item === 'object' && 'id' in item).map((item)=>({
                            id: String(item.id),
                            type: 'menu_dish',
                ...
                const sortedActivities = allActivities.sort((a, b)=>new Date(b.created_at).getTime() - new Date(a.created_at).getTime()).slice(0, 5);
        ...
        children: [
            ...
            activities.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: activities.map((activity)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: `w-10 h-10 rounded-full bg-gradient-to-br from-[#2a2a2a] to-[#1f1f1f] flex items-center justify-center ${getActivityColor(activity.type)}`,
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    className: "text-lg",
...
function WebAppDashboard() {
    ...
    const [loading, setSmartLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useSmartLoading$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSmartLoading"])(false, 150); // Smart loading with 150ms delay
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0054709c._.js.map