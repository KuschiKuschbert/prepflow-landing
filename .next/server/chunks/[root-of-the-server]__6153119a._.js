...
"[project]/.next-internal/server/app/api/supplier-price-lists/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
...
"[project]/app/api/supplier-price-lists/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        let query = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('supplier_price_lists').select(`
        *,
        suppliers (
          id,
          name,
...
async function POST(request) {
    try {
        ...
        if (body.is_current !== false) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('supplier_price_lists').update({
                is_current: false
            }).eq('supplier_id', supplier_id);
        }
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('supplier_price_lists').insert({
...
async function PUT(request) {
    try {
        const body = await request.json();
        const { id, document_name, document_url, effective_date, expiry_date, notes, is_current } = body;
        if (!id) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        if (is_current === true) {
            const { data: currentRecord } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('supplier_price_lists').select('supplier_id').eq('id', id).single();
            if (currentRecord) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('supplier_price_lists').update({
                    is_current: false
                }).eq('supplier_id', currentRecord.supplier_id).neq('id', id);
            }
        }
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('supplier_price_lists').update(updateData).eq('id', id).select(`
        *,
        suppliers (
          id,
          name,
...
async function DELETE(request) {
    try {
        ...
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('supplier_price_lists').delete().eq('id', id);
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6153119a._.js.map