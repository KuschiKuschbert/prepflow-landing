module.exports = [
"[project]/.next-internal/server/app/api/setup-database/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/lib/sample-ingredients-updated.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/api/setup-database/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$sample$2d$ingredients$2d$updated$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/sample-ingredients-updated.ts [app-route] (ecmascript)");
;
;
;
async function POST(request) {
    try {
        ...
        const { data: testData, error: testError } = await supabaseAdmin.from('ingredients').select('id').limit(1);
        if (testError) {
        ...
        const ingredientsData = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$sample$2d$ingredients$2d$updated$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sampleIngredients"];
        // Insert ingredients
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fbac4e43._.js.map