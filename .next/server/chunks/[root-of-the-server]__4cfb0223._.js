...
"[project]/.next-internal/server/app/api/test-recipe-ingredient/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
...
"[project]/app/api/test-recipe-ingredient/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST() {
    try {
        // Get a recipe ID
        const { data: recipes } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('recipes').select('id').limit(1);
        ...
        const { data: ingredients } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('ingredients').select('id').eq('ingredient_name', 'Beef Mince Premium').limit(1);
        if (!ingredients || ingredients.length === 0) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Beef Mince Premium not found'
            }, {
                status: 400
            });
        }
        // Try to insert a recipe ingredient
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('recipe_ingredients').insert({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4cfb0223._.js.map