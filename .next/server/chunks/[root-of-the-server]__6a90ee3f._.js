module.exports = [
"[project]/.next-internal/server/app/api/prep-lists/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/app/api/prep-lists/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('prep_lists').select(`
        *,
        kitchen_sections (
          id,
          name,
...
async function POST(request) {
    try {
        ...
        const { data: prepList, error: prepError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('prep_lists').insert({
            user_id: userId,
        ...
        if (items && items.length > 0) {
            ...
            const { error: itemsError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('prep_list_items').insert(prepItems);
            if (itemsError) {
...
async function PUT(request) {
    try {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('prep_lists').update(updateData).eq('id', id).select().single();
        if (error) {
        ...
        if (items !== undefined) {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('prep_list_items').delete().eq('prep_list_id', id);
            // Add new items
            if (items.length > 0) {
                const prepItems = items.map((item)=>({
                        prep_list_id: id,
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('prep_list_items').insert(prepItems);
            }
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
...
async function DELETE(request) {
    try {
        ...
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('prep_lists').delete().eq('id', id);
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6a90ee3f._.js.map