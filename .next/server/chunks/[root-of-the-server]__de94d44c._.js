...
"[project]/.next-internal/server/app/api/recipes/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
...
async function GET() {
    try {
        ...
        const { data: recipes, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('recipes').select('*').order('name');
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__de94d44c._.js.map