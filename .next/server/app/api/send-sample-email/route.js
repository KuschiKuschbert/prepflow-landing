(()=>{var a={};a.id=716,a.ids=[716],a.modules={261:a=>{"use strict";a.exports=require("next/dist/shared/lib/router/utils/app-paths")},846:a=>{"use strict";a.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},2960:(a,b,c)=>{"use strict";c.r(b),c.d(b,{handler:()=>E,patchFetch:()=>D,routeModule:()=>z,serverHooks:()=>C,workAsyncStorage:()=>A,workUnitAsyncStorage:()=>B});var d={};c.r(d),c.d(d,{POST:()=>y});var e=c(6559),f=c(8088),g=c(7719),h=c(6191),i=c(1289),j=c(261),k=c(2603),l=c(9893),m=c(4823),n=c(7220),o=c(6946),p=c(7912),q=c(9786),r=c(6143),s=c(6439),t=c(3365),u=c(2190);class v{constructor(){this.apiKey=process.env.RESEND_API_KEY||"",this.fromEmail=process.env.FROM_EMAIL||"hello@prepflow.org",this.fromName=process.env.FROM_NAME||"PrepFlow Team"}async sendSampleDashboardEmail(a){try{let b=this.getSampleDashboardTemplate(a),c=await fetch("https://api.resend.com/emails",{method:"POST",headers:{Authorization:`Bearer ${this.apiKey}`,"Content-Type":"application/json"},body:JSON.stringify({from:`${this.fromName} <${this.fromEmail}>`,to:[a.email],subject:b.subject,html:b.html,text:b.text})});if(!c.ok)throw Error(`Email API error: ${c.status} ${c.statusText}`);let d=await c.json();return console.log("\uD83D\uDCE7 Email sent successfully:",d),!0}catch(a){return console.error("\uD83D\uDCE7 Email sending failed:",a),!1}}getSampleDashboardTemplate(a){let b=`Your PrepFlow Sample Dashboard is Ready, ${a.name}! 📊`;return{subject:b,html:`
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
