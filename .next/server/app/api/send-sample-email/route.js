(()=>{var a={};a.id=8716,a.ids=[8716],a.modules={261:a=>{"use strict";a.exports=require("next/dist/shared/lib/router/utils/app-paths")},3295:a=>{"use strict";a.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},10846:a=>{"use strict";a.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},19121:a=>{"use strict";a.exports=require("next/dist/server/app-render/action-async-storage.external.js")},29294:a=>{"use strict";a.exports=require("next/dist/server/app-render/work-async-storage.external.js")},44870:a=>{"use strict";a.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},50891:(a,b,c)=>{"use strict";c.r(b),c.d(b,{handler:()=>E,patchFetch:()=>D,routeModule:()=>z,serverHooks:()=>C,workAsyncStorage:()=>A,workUnitAsyncStorage:()=>B});var d={};c.r(d),c.d(d,{POST:()=>y});var e=c(95736),f=c(9117),g=c(4044),h=c(39326),i=c(32324),j=c(261),k=c(54290),l=c(85328),m=c(38928),n=c(46595),o=c(3421),p=c(17679),q=c(41681),r=c(63446),s=c(86439),t=c(51356),u=c(10641);class v{constructor(){this.apiKey=process.env.RESEND_API_KEY||"",this.fromEmail=process.env.FROM_EMAIL||"hello@prepflow.org",this.fromName=process.env.FROM_NAME||"PrepFlow Team"}async sendSampleDashboardEmail(a){try{let b=this.getSampleDashboardTemplate(a),c=await fetch("https://api.resend.com/emails",{method:"POST",headers:{Authorization:`Bearer ${this.apiKey}`,"Content-Type":"application/json"},body:JSON.stringify({from:`${this.fromName} <${this.fromEmail}>`,to:[a.email],subject:b.subject,html:b.html,text:b.text})});if(!c.ok)throw Error(`Email API error: ${c.status} ${c.statusText}`);let d=await c.json();return console.log("\uD83D\uDCE7 Email sent successfully:",d),!0}catch(a){return console.error("\uD83D\uDCE7 Email sending failed:",a),!1}}getSampleDashboardTemplate(a){let b=`Your PrepFlow Sample Dashboard is Ready, ${a.name}! 📊`;return{subject:b,html:`
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
